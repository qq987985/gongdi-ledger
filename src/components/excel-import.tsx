...
export function TplLink({ href, filename, label = "下载模板" }: { href: string; filename: string; label?: string }) {
  return (
    <a className="btn inline-flex items-center rounded-sm border border-line text-xs hover:bg-accent-soft" href={href} download={filename}>
      {label}
    </a>
  );
}
