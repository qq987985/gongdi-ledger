  ...
  utils.book_append_sheet(
    ...
    titledSheet("合同导入模板", [
      [
        ...
        "保证金金额", "项目部经营人员", "项目进度", "初审金额", "结算应收金额",
        // 1.8.8 D4：补上导出合同表里有、模板没有的 3 列（有无合同/合同扫描件/无合同原因）。
        // 位置与 buildContractWorkbook 的「合同管理表」一致（结算应收金额 之后、备注 之前），
        // 保证「导出→当模板→再导入」的列结构对齐、导入端识别（pick 关键词）不变。
        "有无合同", "合同扫描件", "无合同原因", "备注",
      ],
      [
        1, 2026, "DEMO-A-2026", "示例住宅A区", "示例建设集团", "示例劳务公司", 12e5, "9%",
        "不含税", "", "80%", "", "", "", "", "有", 5e4, "王经营", "在建", 0, 0,
        "有", "", "", "示例，导入前请改",
      ],
    ]),
    "合同管理表",
