...
import { d as confirmRemoveYear, h as nextYear, m as monthStatus } from "./contracts-CQ-BNIxn.js";
import { t as useApp } from "./store-BP65RtMX.js";
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-CjOoadnV.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-DbCMY7WI.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-DbCMY7WI.js");
					await detectNas();
