...
import { d as confirmRemoveYear, h as nextYear, m as monthStatus } from "./contracts-F5LpCrrH.js";
import { t as useApp } from "./store-DMlue1-R.js";
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-BAQdqvBO.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-fATLoyM9.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-fATLoyM9.js");
					await detectNas();
