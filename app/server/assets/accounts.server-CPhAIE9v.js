import { E as writeBookMeta, O as logServer, l as listBookIds, n as appendAudit, p as readBookMeta, r as dataDir, u as persistOn, y as runWithBook } from "./nas-fs.server-Ye-Ou_mg.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-duF7VQKu.js");
