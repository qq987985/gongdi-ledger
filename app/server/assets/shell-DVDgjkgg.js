...
import { _ as monthStatus, f as confirmRemoveYear, v as nextYear } from "./contracts-DPSGQfL0.js";
import { t as useApp } from "./store-CCEaHtiU.js";
import { n as toast } from "./dist-CqIYJTgr.js";
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-CnKaWA1y.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-Ffh-3y49.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-Ffh-3y49.js");
					await detectNas();
