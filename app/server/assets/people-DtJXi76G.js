...
import { n as confirmBatchDelete, o as toggleSel, s as uid } from "./utils-BRICDxN_.js";
import { _ as parseIdCard, f as parseOtRule, g as overAgeLabel, h as normalizeIdDate, j as parseDateYmd, m as wageLabel, v as validateIdCard } from "./contracts-BxZHWnH3.js";
...
import { i as usePhotoFlags, n as PhotoSlot, r as ScanPhotosButton } from "./photo-slot-Dj_OMdSN.js";
...
import { a as useCanSave, i as useCan, n as Need, o as blockedWrite, r as ReadonlyNotice, t as Can } from "./can-Bc-fZtUz.js";
import { t as Badge } from "./badge-D4SFtqa8.js";
import { n as WideTable, r as usePager } from "./wide-table-aL4K3d9n.js";
import { c as TplLink, s as PeopleImport } from "./excel-import-xds2gXjD.js";
import { n as groupBuckets, t as ALL_BUCKETS } from "./buckets-CVtUoKqY.js";
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				form.name ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: "先填姓名再上传。身份证格子正面、反面各一张小图，点小图可放大查看。也可直接拷到 NAS：data/photos/id，文件名「张三-身份证-正面.jpg」「张三-身份证-反面.jpg」。编辑老档案时照片挂在档案原姓名下，改名保存后请重传。"
				})
			]
		})
	});
