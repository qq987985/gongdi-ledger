...
function OverAges({ people, count, className }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		}), show ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
			className: "mt-2 max-h-64 space-y-1 overflow-y-auto border-t border-line pt-2",
			children: people.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: p.name }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: p.idCard ? maskIdCard(p.idCard) : "—"
				})]
			}, p.id))
		}) : null]
	});
