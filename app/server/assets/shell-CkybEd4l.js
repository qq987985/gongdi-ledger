...
import { d as confirmRemoveYear, h as nextYear, m as monthStatus } from "./contracts-C1vBmiZ8.js";
import { t as useApp } from "./store-DM2ztJjg.js";
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-q1YBIQAg.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-C7DvbZju.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-C7DvbZju.js");
					await detectNas();
