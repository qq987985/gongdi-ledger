...
import { C as localToday, b as daysBetween, f as round2 } from "./contracts-DcuNu2WZ.js";
import "./excel-C3TyeZtZ.js";
import { n as useApp } from "./store-DUDhUaSA.js";
import { i as toast } from "./audit-menbPLKJ.js";
import { d as setDoc, l as renameFile, n as DocActions } from "./doc-actions-qNyVRfrs.js";
...
import { n as WideTable, r as usePager } from "./wide-table-Dtiqxw1J.js";
import { n as Need, r as useCan, t as Can } from "./can-Dcxfj09G.js";
import { a as InsuranceMemberImport, c as TplLink } from "./excel-import-mXf3biNb.js";
...
function InsurancePage() {
	...
	const shownMembers = import_react.useMemo(() => {
	...
	const clamp = {
		start: selected?.periodStart || "",
		end: selected?.periodEnd || ""
	};
	const md = (m) => memberDays(m, clamp);
	const settleOf = (m) => round2(perPersonDaily * md(m));
	...
	const leaderSummary = (() => {
		...
		return [...map.entries()].map(([leader$1, v]) => ({
			leader: leader$1,
			...v
		})).sort((a, b) => {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: leaderSummary.map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("tfoot", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "border border-black px-2 py-0.5",
											children: leaderSummary.reduce((s, g) => s + g.count, 0)
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "border border-black px-2 py-0.5",
											children: round2(shownPersonDays)
