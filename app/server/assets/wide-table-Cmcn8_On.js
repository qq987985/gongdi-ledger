...
function usePager(id, list, resetKey) {
	const [size, setSize] = import_react.useState(() => readPageSize(id));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "宽表请左右滑动。有勾选框的表：点一行是勾选，「编辑」在勾选框右边。"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				ref,
				tabIndex: 0,
				role: "region",
				"aria-label": "数据表格，可左右滚动",
				className: cn("wide-scroll overflow-x-scroll rounded-xl border border-line bg-surface focus-visible:outline-2 focus-visible:outline-accent", className),
				children
			}),
			pager ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageBar, {
				size: pager.size,
...
export { WideTable as n, usePager as r, ThHint as t };
