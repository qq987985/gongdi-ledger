import { i as PRESETS, r as PERM_GROUPS } from "./perms-DQTE-mZW.js";
import "./utils-CBhPqRT8.js";
import { a as lockGate, i as hashPassword, n as authStatus, o as unlockGate, t as authOp } from "./auth-eu_OLOze.js";
import { S as wageLabel, d as confirmRemoveYear, h as nextYear, m as monthStatus, p as derivedYears, x as parseOtRule } from "./contracts-BSLoZOKY.js";
import "./excel-D3rRBCuB.js";
import { t as useApp } from "./store-CJN683BW.js";
import { i as pushNasBackup, n as nasEnabled, r as pullNasLedger } from "./nas-sync-Y5Puwv5e.js";
import { t as Button } from "./button-Zdwj1dRR.js";
import { n as Label, t as Input } from "./input-D73Q2_mj.js";
import { n as WinUpdate } from "./shell-lLQgYICS.js";
import { r as useCan, t as Can } from "./can-BfltFJNf.js";
import { t as clearAllPhotos } from "./photos-CvRcX5fq.js";
import { n as PayTypePick, t as OtRulePick } from "./pay-fields-CVP5ikw8.js";
...
function SettingsPage() {
	...
	const [monthWage, setMonthWage] = React.useState(8e3);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(AccountsCard, {}),
			/* @__PURE__ */ jsx(WinUpdate, { compact: true }),
			/* @__PURE__ */ jsx(MembersCard, {}),
			/* @__PURE__ */ jsx(PasswordCard, {}),
			/* @__PURE__ */ jsx(Can, {
				perm: "settings.year",
						...
						/* @__PURE__ */ jsx("ul", {
							...
							children: years.map((y) => {
								...
								return /* @__PURE__ */ jsxs("li", {
									...
									}), years.length > 1 ? /* @__PURE__ */ jsx(Button, {
										variant: "ghost",
										size: "sm",
										onClick: async () => {
				...
				children: /* @__PURE__ */ jsxs("section", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								nasEnabled() ? /* @__PURE__ */ jsx(Button, {
									type: "button",
									onClick: async () => {
										try {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					accessHash ? /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						}), accessHash ? /* @__PURE__ */ jsx(Button, {
							type: "button",
							variant: "outline",
							onClick: async () => {
								if (await hashPassword(current) !== accessHash) {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("ul", {
				...
				children: members.map((m) => /* @__PURE__ */ jsxs("li", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("span", { children: [
							...
							" · ",
							m.username,
							m.isOwner ? /* @__PURE__ */ jsx("span", {
								className: "ml-1 text-xs text-muted",
								children: "创建人"
							}) : null
						] }), !m.isOwner ? /* @__PURE__ */ jsxs("div", {
					...
					}), editId === m.userId ? /* @__PURE__ */ jsx(MemberChecks, {
						checks,
						setChecks,
						onSave: async () => {
				...
				children: [
					/* @__PURE__ */ jsxs("select", {
						...
						children: [/* @__PURE__ */ jsx("option", {
							value: "",
							children: "选择用户加入"
						}), others.map((u) => /* @__PURE__ */ jsxs("option", {
							value: u.id,
							children: [
								u.name,
								" · ",
					...
					/* @__PURE__ */ jsx("select", {
						...
						children: PRESETS.map((p) => /* @__PURE__ */ jsxs("option", {
							value: p.id,
							children: [
								p.label,
								"（",
...
function MemberChecks({ checks, setChecks, onSave, onCancel }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [PERM_GROUPS.map((g) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
			className: "text-xs font-medium text-muted",
			children: g.label
		}), /* @__PURE__ */ jsx("div", {
			className: "mt-1 flex flex-wrap gap-3",
			children: g.items.map((i) => /* @__PURE__ */ jsxs("label", {
...
function AccountsCard() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("ul", {
						...
						children: books.map((b) => /* @__PURE__ */ jsx("li", {
							className: "flex flex-wrap items-center justify-between gap-2 rounded-md border border-line px-3 py-2",
							children: renaming === b.id ? /* @__PURE__ */ jsxs("div", {
								...
								b.name,
								b.id === "default" ? " · 原数据" : "",
								me.role === "admin" && b.ownerId && b.ownerId !== me.id ? /* @__PURE__ */ jsxs("span", {
									className: "ml-1 text-xs text-muted",
								...
								children: [
									...
									b.id !== "default" ? /* @__PURE__ */ jsx(Button, {
										variant: "ghost",
										size: "sm",
										type: "button",
										onClick: async () => {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "当前密码" }), /* @__PURE__ */ jsx(Input, {
							className: "mt-1",
							type: "password",
							value: oldPwd,
							onChange: (e) => setOldPwd(e.target.value)
						})] }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "新密码" }), /* @__PURE__ */ jsx(Input, {
							className: "mt-1",
							type: "password",
							value: newPwd,
			...
			me.role === "admin" ? /* @__PURE__ */ jsxs("div", {
				className: "rounded-xl border border-line bg-surface p-5",
				children: [
					/* @__PURE__ */ jsx("h2", {
						className: "font-semibold",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "初始密码" }), /* @__PURE__ */ jsx(Input, {
								className: "mt-1",
								type: "password",
								value: uPwd,
							...
							return /* @__PURE__ */ jsxs("li", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "显示名" }), /* @__PURE__ */ jsx(Input, {
											className: "mt-1 h-9",
											value: ed.name,
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(Button, {
											...
											children: "保存资料"
										}), u.id !== me.id ? /* @__PURE__ */ jsxs(Fragment, { children: [
											/* @__PURE__ */ jsx(Input, {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "计薪方式" }), /* @__PURE__ */ jsx("div", {
						className: "mt-1",
						children: /* @__PURE__ */ jsx(PayTypePick, {
							value: payType,
							onChange: setPayType
						})
					})] }),
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: payType === "month" ? "月工资" : "日工资" }), payType === "month" ? /* @__PURE__ */ jsx(Input, {
						className: "mt-1",
						type: "number",
						value: monthWage,
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Label, { children: "加班规则" }), /* @__PURE__ */ jsx("div", {
							className: "mt-1",
							children: /* @__PURE__ */ jsx(OtRulePick, {
								value: rule,
								onChange: setRule
							})
						})]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("select", {
						...
						children: teams.map((t) => /* @__PURE__ */ jsx("option", { children: t }, t))
					}),
					/* @__PURE__ */ jsx(Button, {
						type: "button",
						variant: "outline",
