...
import { S as wageLabel, _ as paymentsInYear, b as monthPay, h as nextYear, m as monthStatus, p as derivedYears, x as parseOtRule, y as hasWork } from "./contracts-BSLoZOKY.js";
...
import { s as TplLink, t as AttendanceImport } from "./excel-import-CQOZMU9b.js";
import { a as prepareNamedFile, n as DocActions, r as attendanceBase, u as setDoc } from "./doc-actions-CSEe6Rec.js";
...
function AttendancePage() {
	...
	if (month == null) return /* @__PURE__ */ jsx(YearOverview, {
		onOpen: setMonth,
		onAddYear: () => {
			...
			children: [
				/* @__PURE__ */ jsxs("header", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [
						...
						children: Array.from({ length: 12 }, (_, i) => i + 1).map((m) => /* @__PURE__ */ jsxs("option", {
							value: m,
							children: [m, "月"]
						}, m))
					})]
				}),
				/* @__PURE__ */ jsx(MonthFiles, {
					year,
					month
				}),
				/* @__PURE__ */ jsx(MonthTable, {
					people,
					existing,
					onSave: (rows) => {
...
function YearOverview({ onOpen, onAddYear, upcoming }) {
	...
	const personRows = people.map((p) => {
		const months = Array.from({ length: 12 }, (_, i) => {
			const calc = monthPay(attendance.find((x) => x.year === year && x.month === i + 1 && x.name === p.name), p);
			return {
				days: calc.days,
				pay: calc.pay,
	...
	const [sumTab, setSumTab] = React.useState("pay");
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: Array.from({ length: 12 }, (_, i) => i + 1).map((m) => {
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: filled ? /* @__PURE__ */ jsxs(Fragment, { children: [
								st.filled,
								" 人 · 出勤 ",
								st.days,
								" 天",
			...
			/* @__PURE__ */ jsxs("section", {
				...
				}), sumTab === "pay" ? /* @__PURE__ */ jsx(WideTable, {
					id: "attendance-year",
					...
					children: /* @__PURE__ */ jsxs("table", {
						...
						children: [/* @__PURE__ */ jsx("thead", {
							...
							children: /* @__PURE__ */ jsxs("tr", { children: [
								...
								Array.from({ length: 12 }, (_, i) => /* @__PURE__ */ jsxs("th", {
									className: "p-3",
									children: [i + 1, "月"]
								}, i)),
								/* @__PURE__ */ jsx("th", {
						...
						}), /* @__PURE__ */ jsxs("tbody", { children: [personRows.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
							colSpan: 16,
							className: "p-4 text-muted",
							children: "这一年还没有人出勤。点上面某个月，把实际上班的人加进去。"
						}) }) : null, personRows.map((r) => /* @__PURE__ */ jsxs("tr", {
							...
							children: [
								...
								r.months.map((m, i) => /* @__PURE__ */ jsx("td", {
					...
					children: /* @__PURE__ */ jsxs("table", {
						...
						children: [/* @__PURE__ */ jsx("thead", {
							...
							children: [
								...
								r.months.map((m, i) => /* @__PURE__ */ jsx("td", {
									className: "p-3 text-right tabular-nums",
									children: m.days || m.otHours ? /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", { children: m.days || "—" }), /* @__PURE__ */ jsx("div", {
...
function MonthTable({ people, existing, onSave }) {
	const byName = Object.fromEntries(existing.map((a) => [a.name, a]));
	const [rows, setRows] = React.useState(() => existing.filter((a) => a.name.trim()).map((a) => ({
		name: a.name,
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						}), unused.map((p) => /* @__PURE__ */ jsxs("option", {
							value: p.name,
							children: [
								p.name,
								" ",
				...
				/* @__PURE__ */ jsxs(Button, {
					...
					disabled: !pick,
					children: [/* @__PURE__ */ jsx(UserPlus, { className: "size-4" }), " 加入"]
				}),
				/* @__PURE__ */ jsx(Button, {
					variant: "outline",
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("span", { children: ["加班费 ", /* @__PURE__ */ jsxs("b", {
						className: "tabular-nums",
						children: ["¥", money(totalOt)]
					})] }),
					/* @__PURE__ */ jsxs("span", { children: ["补助 ", /* @__PURE__ */ jsxs("b", {
						className: "tabular-nums",
						children: ["¥", money(totalAllowance)]
					})] }),
					/* @__PURE__ */ jsxs("span", { children: ["扣款 ", /* @__PURE__ */ jsxs("b", {
						className: "tabular-nums",
						children: ["¥", money(totalDeduction)]
					})] }),
					/* @__PURE__ */ jsxs("span", { children: ["应发 ", /* @__PURE__ */ jsxs("b", {
						className: "tabular-nums",
						children: ["¥", money(totalPay)]
					})] }),
					selected.length > 0 ? /* @__PURE__ */ jsxs(Button, {
						variant: "danger",
						size: "sm",
						type: "button",
		...
		/* @__PURE__ */ jsx(WideTable, {
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				}), /* @__PURE__ */ jsxs("tbody", { children: [calcRows.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
					colSpan: 13,
					className: "p-6 text-muted",
					children: "本月还没人。从上方人员表把实际出勤的人加进来，填出勤天数、加班小时、补助、扣款。"
				}) }) : null, calcRows.map((r, i) => /* @__PURE__ */ jsxs("tr", {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("ul", {
				...
				children: list.map((d) => /* @__PURE__ */ jsxs("li", {
