...
import { M as ymKey } from "./contracts-EeNrOMGH.js";
...
function YmPick({ label, years, y, m, d, onY, onM, onD }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
				...
				"aria-label": `${label}年`,
				children: extra.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", {
					value: n,
					children: [n, "年"]
				}, n))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
				...
				"aria-label": `${label}月`,
				children: Array.from({ length: 12 }, (_, i) => i + 1).map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", {
					value: n,
					children: [n, "月"]
				}, n))
			}),
			onD ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
				className: "field-select w-auto",
				value: Math.min(d || 1, new Date(y, m, 0).getDate()),
				onChange: (e) => onD(Number(e.target.value)),
				"aria-label": `${label}日`,
				children: Array.from({ length: new Date(y, m, 0).getDate() }, (_, i) => i + 1).map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", {
					value: n,
					children: [n, "日"]
				}, n))
			}) : null
...
export { monthsInRange as n, rangeLabel as r, YmPick as t };
