import { D as writeBookMeta, b as runWithBook, d as persistOn, i as dataDir, k as logServer, m as readBookMeta, n as appendAudit, u as listBookIds } from "./nas-fs.server-By-UbWI_.js";
import { c as hasPerm, i as PRESETS, o as canManageLedger, s as canWriteLedger, t as ALL_PERMS } from "./perms-h8QMmoTS.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-CK555OgC.js");
