...
import { C as parsePaymentSheet, S as parseFullAttendanceWorkbook, b as parseContractWorkbook, w as parsePeopleSheet, x as parseExpenseSheet, y as parseAttendanceSheet } from "./excel-D3rRBCuB.js";
...
function PeopleImport() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(ExcelBtn, {
		label: "导入人员",
		onFile
	}), fresh.length || conflicts.length ? /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("ul", {
				...
				children: conflicts.map((c, i) => /* @__PURE__ */ jsxs("li", {
