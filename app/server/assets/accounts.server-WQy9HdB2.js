import { _ as runWithBook, c as persistOn, d as readBookMeta, n as dataDir, s as listBookIds, t as appendAudit, w as writeBookMeta } from "./nas-fs.server-CgH-Y1k2.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-CMi_DL0S.js");
