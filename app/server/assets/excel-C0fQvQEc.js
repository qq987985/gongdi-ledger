...
import { C as monthPay, S as hasWork, a as normalizeEntry, c as normalizeIdDate, i as normalizeContractStatus, n as contractRollup, o as splitLegacyReceipts, s as splitTax, u as parseIdCard, v as parseDateYmd, x as getWageAt, y as paymentsInYear } from "./contracts-DHzcdfHV.js";
...
function insuranceMemberTemplateWb() {
	...
	utils.book_append_sheet(wb, noteSheet([
		"填写说明（此表不会导入）",
		"姓名必填；队长手填。",
		"开始日期、结束日期留空时，默认用这个保单的保险期起止。",
		"结束日期还没到今天 = 仍在保；已过今天 = 已结束。替换时系统会自动填结束日期。",
