...
import { r as parseChangelog, t as AppShell } from "./shell-C4-CXcud.js";
...
import { C as writeLedger, _ as saveBackup, b as scanPhotoFolder, c as readAudit, d as readVersionText, i as findPhotoPath, m as removePhoto, o as persistOn, p as removeDocFile, r as findDoc, s as photoFlags, t as appendAudit, u as readLedger, v as saveDoc, x as writeAudit, y as savePhoto } from "./nas-fs.server-C2RR3b3v.js";
import "./perms-CDZPEZ8n.js";
import { a as resolveTenant, n as handleAuthPost, o as withTenant, t as ensureAccounts } from "./accounts.server-B3OBYOB1.js";
import { _ as parseDateYmd, p as dateYear, x as hasWork } from "./contracts-Ddv2VxfU.js";
import { E as peopleTemplateWb, T as paymentTemplateWb, c as buildExpenseWorkbook, d as buildPeopleWorkbook, h as expenseTemplateWb, l as buildFullWorkbook, o as attendanceTemplateWb, p as contractTemplateWb, s as buildContractWorkbook, u as buildPaymentWorkbook } from "./excel-CEulLVmE.js";
import "./store-U11L9wsl.js";
import "./nas-sync-Cnqpeegh.js";
import { t as writeCenteredXlsx } from "./xlsx-center-D3Q3ilvK.js";
import { t as Toaster } from "./dist-DdkhMw2U.js";
...
var Route$28 = class extends BaseRoute {
	constructor(options) {
		super(options);
		this.useMatch = (opts) => {
			return useMatch({
...
var $$splitComponentImporter$12 = () => import("./routes-C8dUD-gq.js");
const Route$1 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$12, "component") });
var $$splitComponentImporter$11 = () => import("./attendance-COYT_9W_.js");
const Route$2 = createFileRoute("/attendance")({ component: lazyRouteComponent($$splitComponentImporter$11, "component") });
var $$splitComponentImporter$10 = () => import("./audit-BxRt10qi.js");
const Route$3 = createFileRoute("/audit")({ component: lazyRouteComponent($$splitComponentImporter$10, "component") });
var $$splitComponentImporter$9 = () => import("./contracts-BPQHSQjW.js");
const Route$4 = createFileRoute("/contracts")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./expenses-CcwcfHKf.js");
...
var $$splitComponentImporter$6 = () => import("./files-B0JTvKEv.js");
const Route$7 = createFileRoute("/files")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./import-Cr8dQSjc.js");
const Route$8 = createFileRoute("/import")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./payments-tm5tSdq1.js");
const Route$9 = createFileRoute("/payments")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./people-BWT6CN1h.js");
const Route$10 = createFileRoute("/people")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./photos-BhKSHcFo.js");
const Route$11 = createFileRoute("/photos")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./query-CnZVDhnm.js");
const Route$12 = createFileRoute("/query")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./settings-bzNDe9R1.js");
const Route$13 = createFileRoute("/settings")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
const Route$14 = createFileRoute("/api/audit")({ server: { handlers: {
	GET: async ({ request }) => {
...
const Route$15 = createFileRoute("/api/auth")({ server: { handlers: {
	GET: async ({ request }) => {
		...
		const { resolveTenant: resolveTenant$1, publicUser, memberList } = await import("./accounts.server-DgDfA9i2.js");
		const { hasPerm } = await import("./perms-B8lKqSVy.js");
...
const Route$16 = createFileRoute("/api/backup")({ server: { handlers: { POST: async ({ request }) => {
	if (!persistOn()) return Response.json({ ok: false }, { status: 400 });
...
const Route$17 = createFileRoute("/api/doc")({ server: { handlers: {
	GET: async ({ request }) => {
...
const Route$18 = createFileRoute("/api/health")({ server: { handlers: { GET: async () => Response.json({
	persist: persistOn(),
	ok: true
}) } } });
const Route$19 = createFileRoute("/api/ledger")({ server: { handlers: {
	GET: async ({ request }) => {
		if (!persistOn()) return Response.json({
			persist: false,
			empty: true
...
const Route$20 = createFileRoute("/api/photo")({ server: { handlers: {
	GET: async ({ request }) => {
...
const Route$21 = createFileRoute("/api/photo-file")({ server: { handlers: { GET: async ({ request }) => {
...
const Route$22 = createFileRoute("/api/photo-flags")({ server: { handlers: {
	GET: async ({ request }) => {
...
const Route$23 = createFileRoute("/api/photo-scan")({ server: { handlers: { POST: async ({ request }) => {
...
const Route$24 = createFileRoute("/api/update")({ server: { handlers: {
	GET: async ({ request }) => {
		try {
			const url = new URL(request.url);
...
const Route$25 = createFileRoute("/api/version")({ server: { handlers: { GET: async () => {
	const text = await readVersionText();
...
const Route$26 = createFileRoute("/api/year")({ server: { handlers: {
...
const Route$27 = createFileRoute("/api/file/$kind")({ server: { handlers: { GET: async ({ params, request }) => {
	const url = new URL(request.url);
...
var rootRouteChildren = {
	...
	PaymentsRoute: Route$9.update({
		id: "/payments",
		path: "/payments",
		getParentRoute: () => Route
	}),
	PeopleRoute: Route$10.update({
		id: "/people",
		path: "/people",
		getParentRoute: () => Route
	}),
	PhotosRoute: Route$11.update({
		id: "/photos",
		path: "/photos",
		getParentRoute: () => Route
	}),
	QueryRoute: Route$12.update({
		id: "/query",
		path: "/query",
		getParentRoute: () => Route
	}),
	...
	ApiAuditRoute: Route$14.update({
		id: "/api/audit",
		path: "/api/audit",
		getParentRoute: () => Route
	}),
	ApiAuthRoute: Route$15.update({
		id: "/api/auth",
		path: "/api/auth",
		getParentRoute: () => Route
	}),
	ApiBackupRoute: Route$16.update({
		id: "/api/backup",
		path: "/api/backup",
		getParentRoute: () => Route
	}),
	ApiDocRoute: Route$17.update({
		id: "/api/doc",
		path: "/api/doc",
		getParentRoute: () => Route
	}),
	ApiHealthRoute: Route$18.update({
		id: "/api/health",
		path: "/api/health",
		getParentRoute: () => Route
	}),
	ApiLedgerRoute: Route$19.update({
		id: "/api/ledger",
		path: "/api/ledger",
		getParentRoute: () => Route
	}),
	ApiPhotoRoute: Route$20.update({
		id: "/api/photo",
		path: "/api/photo",
		getParentRoute: () => Route
	}),
	ApiPhotoFileRoute: Route$21.update({
		id: "/api/photo-file",
		path: "/api/photo-file",
		getParentRoute: () => Route
	}),
	ApiPhotoFlagsRoute: Route$22.update({
		id: "/api/photo-flags",
		path: "/api/photo-flags",
		getParentRoute: () => Route
	}),
	ApiPhotoScanRoute: Route$23.update({
		id: "/api/photo-scan",
		path: "/api/photo-scan",
		getParentRoute: () => Route
	}),
	ApiUpdateRoute: Route$24.update({
		id: "/api/update",
		path: "/api/update",
		getParentRoute: () => Route
	}),
	ApiVersionRoute: Route$25.update({
		id: "/api/version",
		path: "/api/version",
		getParentRoute: () => Route
	}),
	ApiYearRoute: Route$26.update({
		id: "/api/year",
		path: "/api/year",
		getParentRoute: () => Route
	}),
	ApiFileKindRoute: Route$27.update({
		id: "/api/file/$kind",
		path: "/api/file/$kind",
		getParentRoute: () => Route
	})
