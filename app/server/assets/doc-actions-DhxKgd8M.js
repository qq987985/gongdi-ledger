...
import { r as copyText } from "./utils-DqsA5Dz5.js";
import { a as round2 } from "./wage-BVBIWt51.js";
import { g as logOp, v as toast } from "./audit-diff-BCw9WhZ-.js";
import { t as nasEnabled } from "./nas-flag-0jlzrHLn.js";
import { t as createLucideIcon } from "./createLucideIcon-C8gAEEmk.js";
import { n as Download, r as Copy, t as X } from "./x-l1bDvsYR.js";
...
function PreviewModal({ target, onClose }) {
	const dialogRef = import_react.useRef(null);
	import_react.useEffect(() => {
		if (!target) return;
		const previous = document.activeElement instanceof HTMLElement ? document.activeElement : null;
		dialogRef.current?.querySelector("[data-preview-close]")?.focus();
		return () => {
	...
	import_react.useEffect(() => {
		...
		const onKey = (e) => {
			...
			if (e.key !== "Tab") return;
			const controls = dialogRef.current?.querySelectorAll("button, iframe, [tabindex='0']");
...
function DocActions({ id, kind, fileName, suggest, taken = [], onDeleted, onReplaced, readOnly = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PreviewModal, {
		...
		children: [
			...
			onReplaced && !readOnly ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
				ref,
				type: "file",
			...
			onDeleted && fileName && !readOnly ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
...
export { prepareNamedFile as a, removeDoc as c, setDoc as d, Trash as f, invoiceBase as i, renameFile as l, DocActions as n, receiptSubBase as o, Pencil as p, attendanceBase as r, receiptWorkerBase as s, DOC_KIND_LABEL as t, reportBase as u };
