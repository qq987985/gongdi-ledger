...
import { m as daysBetween } from "./contracts-DonCYL5F.js";
import "./excel-YBHp7SId.js";
import { t as useApp } from "./store-CEZ_o1JK.js";
import { n as toast } from "./dist-2eP1hwXK.js";
import "./nas-sync-BzbR7Fam.js";
import { d as setDoc, l as renameFile, n as DocActions } from "./doc-actions-C-TI6pmz.js";
...
import { n as Need, r as useCan, t as Can } from "./can-Bjs-wC4y.js";
import { a as InsuranceMemberImport, c as TplLink } from "./excel-import-ClUpdkuP.js";
...
function InsurancePage() {
	...
	const settleOf = (m) => Math.round(perPersonDaily * md(m) * 100) / 100;
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["累计人天 ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", {
									className: "tabular-nums text-ink",
									children: Math.round(shownPersonDays * 100) / 100
								})] }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
									"保费合计 ",
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", {
										className: "tabular-nums text-ink",
										children: money(Math.round(shownSettle * 100) / 100)
									}),
									" 元"
								] })
							]
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: leaderSummary.map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "border border-black px-2 py-0.5",
										children: Math.round(g.days * 100) / 100
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "border border-black px-2 py-0.5",
										children: money(Math.round(g.settle * 100) / 100)
									})
								] }, g.leader)) }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("tfoot", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
									className: "font-semibold",
