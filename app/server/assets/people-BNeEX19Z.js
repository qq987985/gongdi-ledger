...
import { n as confirmBatchDelete, o as toggleSel, s as uid } from "./utils-xcn-WjZ6.js";
import { E as wageLabel, T as parseOtRule, c as normalizeIdDate, d as validateIdCard, l as overAgeLabel, u as parseIdCard, y as parseDateYmd } from "./contracts-DonCYL5F.js";
...
import { i as usePhotoFlags, n as PhotoSlot, r as ScanPhotosButton } from "./photo-slot-CNkLxVeb.js";
...
import { n as Need, t as Can } from "./can-Bjs-wC4y.js";
import { c as TplLink, s as PeopleImport } from "./excel-import-ClUpdkuP.js";
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				form.name ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: "先填姓名再上传。身份证格子只显示正面，边上可点「查看反面」。也可直接拷到 NAS：data/photos/id，文件名「张三-身份证-正面.jpg」「张三-身份证-反面.jpg」。编辑老档案时照片挂在档案原姓名下，改名保存后请重传。"
				})
			]
		})
	});
