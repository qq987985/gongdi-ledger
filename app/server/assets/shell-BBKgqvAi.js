...
import { t as useApp } from "./store-CEZ_o1JK.js";
import { n as toast } from "./dist-2eP1hwXK.js";
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-DoBaBy_x.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-D29pnXEs.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-D29pnXEs.js");
					await detectNas();
