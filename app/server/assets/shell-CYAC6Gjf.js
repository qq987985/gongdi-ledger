...
import { a as can, l as setLivePerms, n as NAV_PERM, u as subscribePerms } from "./perms-CDZPEZ8n.js";
...
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-qEji0zfO.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-CDbuMhiU.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-CDbuMhiU.js");
					await detectNas();
