...
import { a as prepareNamedFile, n as DocActions, u as setDoc } from "./doc-actions-8VRIgUyF.js";
...
import { r as ExpenseImport, s as TplLink } from "./excel-import-CyboqbNu.js";
...
function ExpensesPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Need, {
		...
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExpenseSheets, { rows: printRows })] })
	});
}
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: [
						...
						className: "border border-black px-1 py-1 font-medium",
						children: col
					}, col)) }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tbody", { children: [rows.map((e, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: [
						i + 1,
						e.name,
						e.period || e.date,
						money(e.amount),
						...
						className: "border border-black px-1 py-1",
						children: v
					}, k)) }, e.id)), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: [
						"合计",
						"",
						"",
						money(total),
