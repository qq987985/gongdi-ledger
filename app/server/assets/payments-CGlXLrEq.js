...
import { a as money, n as confirmBatchDelete, o as toggleSel } from "./utils-xcn-WjZ6.js";
import { C as localToday, E as parseDateYmd, x as derivedYears, y as dateYear } from "./contracts-CAQZ1rFU.js";
...
import { c as TplLink, o as PaymentImport } from "./excel-import-B8xY3kgI.js";
...
function PaymentsPage() {
	...
	const [batch, setBatch] = import_react.useState("all");
	...
	const ranged = import_react.useMemo(() => {
	...
	const batches = import_react.useMemo(() => [...new Set(ranged.map((p) => p.source).filter(Boolean))], [ranged]);
	...
	const byOwner = import_react.useMemo(() => {
