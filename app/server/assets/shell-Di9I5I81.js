...
import { a as can, d as subscribePerms, n as NAV_PERM, u as setLivePerms } from "./perms-DxXw_WvE.js";
...
import { n as useApp } from "./store-CzoyQsGf.js";
import { n as toast } from "./dist-2eP1hwXK.js";
import { i as pullNasLedger, n as flushPendingLedger, r as nasEnabled } from "./nas-sync-B01J0-Zq.js";
...
import { n as Camera, t as X } from "./x-BpiVvvCv.js";
import { t as Download } from "./download-i4g052d8.js";
...
import { a as lockGate, i as hashPassword, n as authStatus, o as unlockGate, r as gateUnlocked, t as authOp } from "./auth-dkz28-CK.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-BCjGHDXp.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-BCjGHDXp.js");
					await detectNas();
