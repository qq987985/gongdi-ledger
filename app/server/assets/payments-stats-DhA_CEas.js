import { _ as ymKey, a as round2, h as parseDateYmd } from "./wage-BVBIWt51.js";
import { g as receiverOf, h as ownerKey } from "./contracts-FU2UPdFm.js";
...
function scopeRows(rows, owner) {
	return owner === "__all__" ? rows : rows.filter((p) => inBucket(ownerKey(p), owner));
}
