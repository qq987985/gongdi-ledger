import { F as logServer, M as dataDir, N as persistOn, P as runWithBook, f as readBookMeta, l as listBookIds, n as appendAudit, v as writeBookMeta } from "./nas-fs.server-kKMwODWe.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-XaHEb1Mn.js");
...
export { memberList as a, withTenant as c, handleAuthPost as i, accountsUnreadable as n, publicUser as o, ensureAccounts as r, resolveTenant as s, ACCOUNTS_BROKEN_MSG as t };
