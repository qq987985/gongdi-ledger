import { D as runWithBook, E as persistOn, O as logServer, T as dataDir, c as readBookMeta, m as writeBookMeta, o as listBookIds, t as appendAudit } from "./nas-fs.server-LV00PD5P.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-B_uOIEcV.js");
