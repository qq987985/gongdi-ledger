...
async function authStatus() {
	...
	if (!r.ok && !broken || typeof j?.persist !== "boolean") throw new Error("无法确认服务器登录状态，请稍后重试");
	return {
		persist: j.persist,
...
export { lockGate as a, hashPassword as i, authStatus as n, unlockGate as o, gateUnlocked as r, authOp as t };
