import { A as runWithBook, O as dataDir, c as readBookMeta, j as logServer, k as persistOn, m as writeBookMeta, o as listBookIds, t as appendAudit } from "./nas-fs.server-5klkVKxw.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-DwmVJnkK.js");
