import { F as runWithBook, I as logServer, N as dataDir, P as persistOn, _ as writeBookMeta, c as listBookIds, d as readBookMeta, n as appendAudit } from "./nas-fs.server-Bx8iAzgO.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-62Cwc1KJ.js");
