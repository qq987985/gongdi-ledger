...
function ExportPage() {
	...
	const href = (kind) => exportHref(kind, scope, year, rangeSwapped ? Math.min(fromY * 12 + fromM, toY * 12 + toM) === fromY * 12 + fromM ? fromY : toY : fromY, rangeSwapped ? Math.min(fromY * 12 + fromM, toY * 12 + toM) === fromY * 12 + fromM ? fromM : toM : fromM, rangeSwapped ? Math.max(fromY * 12 + fromM, toY * 12 + toM) === fromY * 12 + fromM ? fromY : toY : toY, rangeSwapped ? Math.max(fromY * 12 + fromM, toY * 12 + toM) === fromY * 12 + fromM ? fromM : toM : toM);
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								"导出范围：",
								rangeText,
								scope === "range" && rangeSwapped ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "ml-2 text-warn",
									children: "起止选反了，会把区间自动换回来再导出。"
								}) : null
							]
						})
					]
