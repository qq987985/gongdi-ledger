...
import { n as summarizeYear, r as teamRows, t as fallbackPayYear } from "./attendance-summary-5E0j9IyN.js";
import { t as contractPayable } from "./contracts-totals-HvQxqJCT.js";
...
function Home() {
	...
	const { should, paid, pendingAmt, proxyCount: proxy, filledMonths: monthsFilled } = summarizeYear({
		people,
		attendance,
		payments,
		year,
