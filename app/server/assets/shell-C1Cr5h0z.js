...
import { _ as monthStatus, f as confirmRemoveYear, v as nextYear } from "./contracts-2dNdatyD.js";
import { t as useApp } from "./store-CzzV_PZJ.js";
import { n as toast } from "./dist-CqIYJTgr.js";
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-_KTt_a2M.js";
...
import { n as Camera, t as X } from "./x-D3T62NFJ.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-Ci0Ph7jT.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-Ci0Ph7jT.js");
					await detectNas();
