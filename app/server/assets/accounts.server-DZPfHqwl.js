import { D as writeBookMeta, b as runWithBook, d as persistOn, i as dataDir, k as logServer, m as readBookMeta, n as appendAudit, u as listBookIds } from "./nas-fs.server-pyn7e0l1.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-B5siV_H2.js");
