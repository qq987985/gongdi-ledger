import { F as persistOn, I as runWithBook, L as logServer, P as dataDir, f as readBookMeta, l as listBookIds, n as appendAudit, v as writeBookMeta } from "./nas-fs.server-CVhLeN_j.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-ABYpX4Z0.js");
