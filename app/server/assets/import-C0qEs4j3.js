...
import { p as derivedYears } from "./contracts-BSLoZOKY.js";
import "./excel-D3rRBCuB.js";
import { t as useApp } from "./store-CJN683BW.js";
import "./button-Zdwj1dRR.js";
import "./input-D73Q2_mj.js";
import { t as Can } from "./can-BfltFJNf.js";
import "./file-pick-BdsLRyGI.js";
import { a as PaymentImport, i as FullBookImport, n as ContractImport, o as PeopleImport, r as ExpenseImport, s as TplLink, t as AttendanceImport } from "./excel-import-CQOZMU9b.js";
import { t as YmPick } from "./ym-pick-Nze9YmJM.js";
			...
			children: [
				/* @__PURE__ */ jsxs("section", {
					...
					children: [
						...
						scope === "year" ? /* @__PURE__ */ jsx("div", {
							className: "mt-3",
							children: /* @__PURE__ */ jsx("select", {
								className: "field-select",
								value: year,
								onChange: (e) => setYear(Number(e.target.value)),
								children: yearList.map((y) => /* @__PURE__ */ jsxs("option", {
									value: y,
									children: [y, " 年"]
								}, y))
							})
						}) : scope === "range" ? /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											className: "mt-3 flex flex-wrap gap-2",
											children: [/* @__PURE__ */ jsx(TplLink, {
												href: "/api/file/people-template",
												filename: "人员导入模板.xlsx"
											}), /* @__PURE__ */ jsx(PeopleImport, {})]
										})
									]
								}),
								/* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							className: "mt-3",
							children: /* @__PURE__ */ jsx(FullBookImport, {})
						})
					]
				})
			]
