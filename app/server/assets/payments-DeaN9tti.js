...
import { _ as ymKey, a as round2, c as dateYear, f as localToday, g as paymentsInYear, h as parseDateYmd, u as derivedYears } from "./wage-BVBIWt51.js";
import { g as receiverOf, h as ownerKey, m as nameKey, p as isProxyReceiver } from "./contracts-FU2UPdFm.js";
...
import { c as TplLink, o as PaymentImport } from "./excel-import-B1XcuBh9.js";
import { t as ALL_BUCKETS } from "./buckets-DTFLM3XC.js";
import { _ as sectionTotals, c as ownerTotals, d as paymentsInRange, f as printCaliberNote, g as scopeRows, h as printTotals, i as isPaid, l as panelRows, m as printSummary, n as detailSections, o as isPending, p as printOwnerBuckets, r as filterPayments, t as PROXY_INLINE_LABEL, u as paymentSummary, v as sourceBuckets } from "./payments-stats-DhA_CEas.js";
import { n as summarizeYear } from "./attendance-summary-iUExKhQj.js";
...
function planPendingBatch(input) {
	const { people, attendance, payments, year } = input;
	const fallbackYear = input.fallbackYear ?? year;
	const q = (input.q || "").trim();
	const minAmount = Number.isFinite(input.minAmount) ? Number(input.minAmount) : .005;
	...
	const pendingOwners = new Set(paymentsInYear(payments, year, fallbackYear).filter(isPending).map((p) => ownerKey(p)).filter(Boolean));
	const plan = {
		year,
		items: [],
		total: 0,
...
function pendingPaymentsOf(plan, opts = {}) {
...
function PaymentsPage() {
	...
	const [pendingOpen, setPendingOpen] = import_react.useState(false);
	...
	const pendingPlan = import_react.useMemo(() => planPendingBatch({
		people,
	...
	const pendingSource = batch === "__all__" ? "" : batch;
	...
	function confirmPendingBatch() {
		...
		if (!confirm(`按应发为这 ${rows.length} 人生成待发放记录（合计 ¥${money(pendingPlan.total)}）？\n\n记录的发放日期留空 = 待发放；发钱后补上发放日期即算已发。\n该年已有待发放记录的人不会再生成，已有的发放记录不会被动到。`)) return;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Need, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								type: "button",
								disabled: !canEditPay,
								title: canEditPay ? "按本年应发（考勤×工资口径）为还没登记的每个人生成一条待发放记录，日期留空" : `你是只读账号（缺「${permLabel("payments.edit")}」权限），改动不会保存。`,
				...
				pendingOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									...
									type: "button",
									disabled: !pendingPlan.items.length,
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									className: "text-xs text-muted",
									children: [
										"应发 = 本年考勤按工资口径算出的「全年」（与总览「应发合计」、考勤页年度表同一份计算）； 本次生成金额 = 应发 − 已发（已发按实际收款人计入、含代发）。生成出来的记录",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "日期留空 = 待发放" }),
										"，发钱后给它们补上日期即算已发。",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									...
									children: [
										"将新增 ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: pendingPlan.items.length }),
										" 笔 · 合计 ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("b", { children: ["¥", money(pendingPlan.total)] }),
										planSkipNote(pendingPlan) ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											className: "text-xs text-muted",
											children: [" · 跳过：", planSkipNote(pendingPlan)]
										}) : null
									]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
										...
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: pendingPlan.items.map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
													className: "p-3 text-muted",
													children: it.team || "未分班组"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
													className: "p-3 text-right tabular-nums",
													children: ["¥", money(it.should)]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
													className: "p-3 text-right tabular-nums",
													children: ["¥", money(it.paid)]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
													className: "p-3 text-right tabular-nums font-medium",
													children: ["¥", money(it.amount)]
												})
											]
										}, it.owner)) })]
									})
