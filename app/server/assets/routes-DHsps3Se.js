import { i as money } from "./utils-CBhPqRT8.js";
import { _ as paymentsInYear, b as monthPay, l as overAgeLabel, m as monthStatus, n as contractRollup, p as derivedYears } from "./contracts-BSLoZOKY.js";
		...
		children: [
			/* @__PURE__ */ jsxs("header", { children: [
				...
				/* @__PURE__ */ jsx("p", {
					...
					children: people.length ? `当前工作年 ${year}。人员共用；考勤、发放、合同都按年查看。要加新年到「月度考勤」里点新增年。` : "还没有人员。到各模块下载模板导入，或到「导入导出」导入整本。"
				})
			] }),
			/* @__PURE__ */ jsx("section", {
				className: "flex flex-wrap items-center gap-2",
				children: years.map((y) => /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: () => setYear(y),
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: teamRows.map((r) => /* @__PURE__ */ jsxs("li", {
							className: "flex items-center justify-between text-sm",
							children: [/* @__PURE__ */ jsx("span", { children: r.team }), /* @__PURE__ */ jsxs("span", {
