...
import { _ as monthStatus, f as confirmRemoveYear, v as nextYear } from "./contracts-DSY3U21v.js";
import { t as useApp } from "./store-Bg7Z69Jg.js";
import { n as toast } from "./dist-2eP1hwXK.js";
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-DF9OL_LZ.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-D5qzU6Dh.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-D5qzU6Dh.js");
					await detectNas();
