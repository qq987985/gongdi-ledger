...
import { a as money, r as copyText } from "./utils-BRICDxN_.js";
import { E as derivedYears, N as ymKey, P as hasContent, d as monthPay, f as parseOtRule, g as overAgeLabel, m as wageLabel, u as getWageAt } from "./contracts-BxZHWnH3.js";
import { n as receiverOf, t as isProxyReceiver } from "./receiver-BxQOI1ff.js";
...
import { a as Check, n as PhotoSlot } from "./photo-slot-Dj_OMdSN.js";
import { r as Copy, t as X } from "./x-BvEpiMYn.js";
import { n as DocActions } from "./doc-actions-B41YjD6j.js";
import "./file-pick-JlPC7W8h.js";
import { t as Button } from "./button-FMhrD3dQ.js";
import { n as Need } from "./can-Bc-fZtUz.js";
import { t as Badge } from "./badge-D4SFtqa8.js";
import { n as groupBuckets } from "./buckets-CVtUoKqY.js";
import { a as isPaidSelf } from "./payments-stats-B-sUaY16.js";
import { n as monthsInRange, r as rangeLabel, t as YmPick } from "./ym-pick-D5K12wQ4.js";
import "./photos-aSeRCE9q.js";
...
function buildSlips({ people, names, span, attendance, payments, dateFrom, dateTo }) {
	return names.map((name) => {
		...
		const pays = payments.filter((x) => {
			...
			return true;
		}).slice().sort((a, b) => a.date.localeCompare(b.date)).map((x) => ({
			date: x.date,
			amount: x.amount || 0,
			owner: x.owner,
		...
		const paid = pays.filter(isPaidSelf).reduce((s, x) => s + x.amount, 0);
		const collected = pays.filter((x) => x.owner !== name).reduce((s, x) => s + x.amount, 0);
		const proxyOut = pays.filter((x) => x.owner === name && !isPaidSelf(x)).reduce((s, x) => s + x.amount, 0);
		return {
			person: p,
...
function groupSlips(slips, showMonths, showPays) {
	const groups = [];
	const isBig = (s) => {
		return (showMonths ? s.months.length : 0) + (showPays ? s.pays.length : 0) > 8;
	};
	let i = 0;
...
function PayslipSheets({ slips, rangeLabel: label, printMode }) {
	const showMonths = printMode !== "pays";
	const showPays = printMode !== "wage";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "print-only text-black",
		children: import_react.useMemo(() => groupSlips(slips, showMonths, showPays), [
			slips,
			showMonths,
			showPays
		]).map((group, gi) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: printMode === "pays" ? "台账 · 打款记录" : "台账 · 工资条"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							printMode === "pays" ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["工资：", s.hasHistory ? "按各月生效工资（见明细）" : wageLabel(s.person)] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["加班：", parseOtRule(s.person.otRule).label || "—"] })] })
						]
					}),
					showMonths ? s.months.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					showMonths ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					showPays ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: [
								...
								s.pays.map((x, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "border border-black px-1 py-1",
										children: x.date
									}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "border border-black px-1 py-1",
										children: receiverOf(x) === s.person.name ? "本人" : `${receiverOf(x)}代收`
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "border border-black px-1 py-1",
										children: x.source
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "border border-black px-1 py-1",
										colSpan: 3,
										children: showMonths ? `未打款 ¥${money(s.total - s.paid)}` : ""
									})
								] }),
								s.collected ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
									className: "border border-black px-1 py-1",
									colSpan: 5,
									children: [
										"另代收他人 ¥",
								...
								s.proxyOut ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
									className: "border border-black px-1 py-1",
									colSpan: 5,
									children: [
										"其中本人名下 ¥",
										money(s.proxyOut),
										" 由他人代领（收款人非本人），按口径不算本人已打款，单列。"
									]
								}) }) : null
							] })]
...
function QueryPage() {
	...
	const [printMode, setPrintMode] = import_react.useState("both");
	...
	const effectiveSlips = import_react.useMemo(() => {
		if (printMode === "pays") return slips.filter((s) => s.pays.length > 0);
		if (printMode === "wage") return slips.filter((s) => s.months.length > 0);
		return slips;
	}, [slips, printMode]);
	const teams = groupBuckets(people.map((x) => x.team), "未分班组");
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
										...
										children: ["打印", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
										...
										onClick: () => {
											...
											if (!effectiveSlips.length) {
												toast.error(printMode === "pays" ? "所选人在该区间没有打款记录" : "所选人在该区间没有出勤或打款，没有工资条");
												return;
											}
											window.print();
										},
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									teams.map((b) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
										variant: "ghost",
										size: "sm",
										type: "button",
					...
					p ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						...
						children: "还没有人员。先在「人员」里添加。"
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted",
						children: "上面的输入框里选一个人，这里就显示他的工资、考勤、发放和影像；只想打印工资条的话， 点「选择人员」勾选人名后直接点「打印」。"
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PayslipSheets, {
				slips: effectiveSlips,
