...
import { O as localToday, i as emptyContract, n as contractEntryChanges, o as normalizeEntry, p as round2, r as contractRollup, t as CONTRACT_STATUSES } from "./contracts-DGbQwm5e.js";
import { r as buildContractWorkbook } from "./excel-Ie8Uor1h.js";
import { n as useApp } from "./store-C5O-5wyp.js";
import { i as toast } from "./audit-BAusgva9.js";
import { a as prepareNamedFile, c as removeDoc, d as setDoc, f as Trash, i as invoiceBase, n as DocActions, o as receiptSubBase, p as Pencil, s as receiptWorkerBase, u as reportBase } from "./doc-actions-BWic4300.js";
import { n as FilePick } from "./file-pick-BFNvYoRY.js";
...
import { n as WideTable, r as usePager, t as ThHint } from "./wide-table-7YPgTurv.js";
import { n as ContractImport } from "./excel-import-YkX_S5gT.js";
import { t as useGuardedClose } from "./confirm-close-DO5BDHka.js";
import { n as sumContractRollups } from "./contracts-totals-BVYyzW1l.js";
...
function ContractEditor({ draft, creating, entries, onCancel, onSave, onDelete, onAddEntry, onUpdateEntry, onRemoveEntries }) {
...
function useTakenNames() {
	...
	return [...entries.map((e) => e.fileName), ...(docs || []).map((d) => d.fileName)].filter((x) => Boolean(x));
}
function askEntryEdit(kindLabel, before, after) {
...
function ReportBook({ contract, entries, disabled, onAdd, onUpdate, onRemove }) {
	const [editId, setEditId] = import_react.useState("");
	const [date, setDate] = import_react.useState(localToday());
	...
	async function submit() {
		if (editing) {
			const fileName$1 = file ? file.name || "（已选新文件）" : editing.fileName;
			if (!askEntryEdit("报量", editing, {
				...editing,
				date,
				amount,
				no,
			...
			const saved = file ? await attachNamed(editing.id, "report", file, reportBase(contract.name, date, amount), taken) : editing.fileName;
			onUpdate(normalizeEntry({
				...editing,
				date,
				amount,
				no,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						type: "button",
						onClick: submit,
						children: editing ? "保存这笔报量的修改" : "记一笔报量"
					}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(EntryRows, {
				...
				title: "报量",
				onRemove,
				onEdit: disabled ? void 0 : startEdit,
				editingId: editId,
...
function InvoiceBook({ contract, entries, disabled, onAdd, onUpdate, onRemove }) {
	const [editId, setEditId] = import_react.useState("");
	const [date, setDate] = import_react.useState(localToday());
	...
	async function submit() {
		if (editing) {
			...
			const saved = file ? await attachNamed(editing.id, "invoice", file, invoiceBase(contract.name, date, incl), taken) : editing.fileName;
			onUpdate(normalizeEntry({
				...editing,
				date,
				amount: incl,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						type: "button",
						onClick: submit,
						children: editing ? "保存这张发票的修改" : "记一张发票"
					}),
					editing ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						size: "sm",
						variant: "outline",
...
function ReceiptBook({ contract, entries, disabled, onAdd, onUpdate, onRemove }) {
	const [editId, setEditId] = import_react.useState("");
	const [date, setDate] = import_react.useState(localToday());
	const [amount, setAmount] = import_react.useState(0);
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						type: "button",
						onClick: submit,
						children: editing ? "保存这笔收款的修改" : "记一笔收款"
					}),
					editing ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						size: "sm",
						variant: "outline",
...
function EntryRows({ entries, title, onRemove, onEdit, editingId, render }) {
		...
		children: [entries.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [onEdit ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					"aria-label": "编辑",
					title: "改这一笔",
					"data-editing": editingId === e.id ? "1" : void 0,
					onClick: () => onEdit(e),
...
function ContractScanBox({ contract, onFileName }) {
	const taken = (useApp((s) => s.contracts) || []).map((c) => c.scanFileName).filter((x) => Boolean(x));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		id: "contract-scan",
...
function MiniTable({ caption, title, heads, rows, empty }) {
	const label = `${caption} · ${title}`;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		className: "mt-4",
		children: rows.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
			...
			className: "print-title text-sm font-semibold",
			children: label
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: items.map(({ contract: c, entries }) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
				className: "statement print-doc border border-black p-4",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						className: "print-keep border-b border-black pb-2 text-center",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function ContractsPage() {
	...
	const totals = import_react.useMemo(() => sumContractRollups(list, contractEntries), [list, contractEntries]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Need, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReadonlyNotice, { perm: "contracts.edit" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								onClick: async () => {
									...
									const buf = await writeCenteredXlsx(buildContractWorkbook({
										contracts,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								...
								title: canEditContract ? void 0 : `你是只读账号（缺「${permLabel("contracts.edit")}」权限），改动不会保存。`,
								onClick: () => {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
												tone: CONTRACT_DONE.has(c.status) ? "ok" : "warn",
												children: CONTRACT_STATUSES.find((s) => s === c.status) || c.status
											})
										})
									]
								}, c.id);
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
											...
											className: "text-xs text-muted",
											children: ["不含税 ", money(totals.reportExcl)]
										})]
									}),
