...
import { a as Check, n as PhotoSlot } from "./photo-slot-D0gNEr45.js";
import { t as Copy } from "./copy-Z5Y1reIq.js";
import { n as DocActions } from "./doc-actions-DWsnOzDb.js";
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["工资：", s.hasHistory ? "按各月生效工资（见明细）" : wageLabel(s.person)] }),
...
function QueryPage() {
	...
	const effectiveSlips = import_react.useMemo(() => printMode === "pays" ? slips.filter((s) => s.pays.length > 0) : slips, [slips, printMode]);
