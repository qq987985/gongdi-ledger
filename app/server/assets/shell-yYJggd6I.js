...
import { _ as monthStatus, f as confirmRemoveYear, v as nextYear } from "./contracts-CkBkdQjS.js";
import { n as useApp } from "./store-DWyZVOeb.js";
import { i as toast } from "./audit-BAusgva9.js";
import { i as pullNasLedger, n as flushPendingLedger, r as nasEnabled } from "./nas-sync-B1Fs2WYd.js";
...
import { t as Plus } from "./plus-DJt_OiIg.js";
import { t as Trash } from "./trash-6kNWHHjA.js";
import { t as Button } from "./button-BRe1hAcl.js";
import { n as Label, t as Input } from "./input-IsycmYDi.js";
import { a as lockGate, i as hashPassword, n as authStatus, o as unlockGate, r as gateUnlocked, t as authOp } from "./auth-BMxwGs9i.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-CX86fBih.js");
				await startNasSync();
			} catch {}
...
function WinUpdate({ compact }) {
	...
	async function finishUpdate(target) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			jobLog ? jobLog.log || jobLog.errorText ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", {
				...
				children: [jobLog.errorText, jobLog.log].filter(Boolean).join("\n\n")
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-CX86fBih.js");
					await detectNas();
