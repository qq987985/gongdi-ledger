...
import { a as can, l as setLivePerms, n as NAV_PERM, u as subscribePerms } from "./perms-C-hDVhes.js";
...
import { _ as nextYear, f as confirmRemoveYear, g as monthStatus } from "./contracts-GTeYhILo.js";
import { t as useApp } from "./store-mK9usRg2.js";
import { n as toast } from "./dist-CqIYJTgr.js";
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-CFHZ2EtW.js";
import { t as createLucideIcon } from "./createLucideIcon-J1zCoE4A.js";
import { n as CalendarDays, t as RotateCcwClock } from "./rotate-ccw-clock-CpHQR4Y2.js";
import { n as Camera, t as X } from "./x-D0WHQmPf.js";
import { t as Download } from "./download-B4CwaK5a.js";
import { t as Plus } from "./plus-BAEsXAe6.js";
import { t as Trash2 } from "./trash-2-BBtd_2N7.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-Bq1YaJeo.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-Bq1YaJeo.js");
					await detectNas();
