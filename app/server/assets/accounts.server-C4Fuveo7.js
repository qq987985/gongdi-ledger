import { T as writeBookMeta, c as listBookIds, f as readBookMeta, l as persistOn, n as dataDir, t as appendAudit, v as runWithBook } from "./nas-fs.server-B1qOG7xP.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-Dmv3DQxU.js");
