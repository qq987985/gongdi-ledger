...
import { A as derivedYears, L as ymKey, R as hasContent, S as receiverOf, b as nameKey, d as monthPay, f as parseOtRule, g as overAgeLabel, m as wageLabel, u as getWageAt, x as ownerKey, y as isProxyReceiver } from "./contracts-CNGvTFF_.js";
...
function buildSlips({ people, names, span, attendance, payments, dateFrom, dateTo }) {
	return names.map((rawName) => {
		...
		const collected = pays.filter((x) => ownerKey(x) !== name).reduce((s, x) => s + x.amount, 0);
		const proxyOut = pays.filter((x) => ownerKey(x) === name && !isPaidSelf(x)).reduce((s, x) => s + x.amount, 0);
		return {
			person: p,
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: [
								...
								s.pays.map((x, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "border border-black px-1 py-1",
										children: receiverOf(x) === nameKey(s.person.name) ? "本人" : `${receiverOf(x)}代收`
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "border border-black px-1 py-1",
										children: x.source
									...
									children: [(attendanceDocs || []).filter((d) => span.some((x) => x.year === d.year && x.month === d.month)).map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
											...
											onReplaced: (name$1) => {
												...
												patchAttendanceDoc(d.id, { fileName: name$1 });
											},
											onDeleted: () => {
												if (blockedWrite("attendance.edit", permLabel("attendance.edit"))) return;
