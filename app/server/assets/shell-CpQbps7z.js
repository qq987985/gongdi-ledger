...
import { _ as monthStatus, f as confirmRemoveYear, v as nextYear } from "./contracts-BlS_6tCr.js";
import { t as useApp } from "./store-DvyK8Mhl.js";
import { n as toast } from "./dist-2eP1hwXK.js";
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-vuO7skQb.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-CyLBIQuh.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-CyLBIQuh.js");
					await detectNas();
