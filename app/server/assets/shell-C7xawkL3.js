...
import { n as useApp } from "./store-TZGfzJAF.js";
import { i as toast } from "./audit-BAusgva9.js";
import { i as pullNasLedger, n as flushPendingLedger, r as nasEnabled } from "./nas-sync-BeRuGCdk.js";
...
import { a as lockGate, i as hashPassword, n as authStatus, o as unlockGate, r as gateUnlocked, t as authOp } from "./auth-CrysUkJ4.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-BYheLSTU.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-BYheLSTU.js");
					await detectNas();
