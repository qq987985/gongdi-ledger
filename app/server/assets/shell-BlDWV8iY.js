...
import { f as confirmRemoveYear, v as monthStatus, y as nextYear } from "./contracts-BHC464Y4.js";
import { n as useApp } from "./store-7Y3fvtZP.js";
import { i as toast } from "./audit-BAusgva9.js";
import { i as pullNasLedger, n as flushPendingLedger, r as nasEnabled } from "./nas-sync-qkf1gpv4.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-Y7Y7PxeJ.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-Y7Y7PxeJ.js");
					await detectNas();
