import { r as copyText } from "./utils-CBhPqRT8.js";
import { n as nasEnabled } from "./nas-sync-Y5Puwv5e.js";
		...
		children: [
			fileName ? /* @__PURE__ */ jsxs(Fragment, { children: [
				/* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(Eye, { className: "mr-1 inline size-3" }), "查看"]
				}),
				/* @__PURE__ */ jsxs("button", {
					type: "button",
					className: "rounded-sm border border-line px-1.5 py-0.5 text-[11px] hover:border-accent",
					...
					children: [/* @__PURE__ */ jsx(Download, { className: "mr-1 inline size-3" }), "下载"]
				}),
				/* @__PURE__ */ jsxs("button", {
					type: "button",
					className: "rounded-sm border border-line px-1.5 py-0.5 text-[11px] hover:border-accent",
					...
					children: [/* @__PURE__ */ jsx(Copy, { className: "mr-1 inline size-3" }), "复制"]
				})
			] }) : /* @__PURE__ */ jsx("span", {
				className: "self-center text-[11px] text-subtle",
				children: "未上传"
			}),
			onReplaced ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("input", {
				ref,
				type: "file",
				...
				children: [/* @__PURE__ */ jsx(Pencil, { className: "mr-1 inline size-3" }), fileName ? "替换" : "上传"]
			})] }) : null,
			onDeleted && fileName ? /* @__PURE__ */ jsxs("button", {
				type: "button",
				...
				children: [/* @__PURE__ */ jsx(Trash2, { className: "mr-1 inline size-3" }), "删除"]
			}) : null
		]
	});
}
export { prepareNamedFile as a, removeDoc as c, invoiceBase as i, reportBase as l, DocActions as n, receiptSubBase as o, attendanceBase as r, receiptWorkerBase as s, DOC_KIND_LABEL as t, setDoc as u };
