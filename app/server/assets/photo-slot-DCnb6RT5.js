...
import { t as DropSurface } from "./file-pick-BFNvYoRY.js";
import { t as Button } from "./button-rfWlLS9P.js";
import { a as fileToDataUrl, c as scanPhotoFolder, i as downloadPhoto, l as setPhoto, n as copyPhoto, o as getPhoto, r as deletePhoto, s as listPhotoFlags } from "./photos-EegZVaWY.js";
...
function IdCardSlot({ name, compact, readOnly = false, onChanged }) {
...
function SinglePhotoSlot({ name, kind, label, compact, readOnly = false, onChanged }) {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropSurface, {
				...
				children: [
					...
					!readOnly ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
						type: "file",
						accept: photoAccept,
						className: "sr-only",
						onChange: (e) => {
...
function PhotoSlot({ name, kind, compact, readOnly = false, onChanged }) {
