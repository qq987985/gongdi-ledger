import { C as writeBookMeta, g as runWithBook, n as dataDir, o as listBookIds, s as persistOn, t as appendAudit, u as readBookMeta } from "./nas-fs.server-Daz2tm8t.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-nB8jBmeO.js");
