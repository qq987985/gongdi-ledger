...
import { n as WideTable, r as usePager } from "./wide-table-BUKe7FLR.js";
import { n as Need } from "./can-BfltFJNf.js";
import "./file-pick-BdsLRyGI.js";
import { r as ExpenseImport, s as TplLink } from "./excel-import-CQOZMU9b.js";
import { a as prepareNamedFile, n as DocActions, u as setDoc } from "./doc-actions-CSEe6Rec.js";
...
function NameInput({ value, onChange, names, listId, placeholder }) {
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Input, {
		...
		id: listId,
		children: (names || []).map((n) => /* @__PURE__ */ jsx("option", { value: n }, n))
	})] });
}
function VoucherSlot({ title, hint, id, kind, fileName, optional, extra, onFile, onDeleted }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			fileName ? /* @__PURE__ */ jsx(Badge, {
				tone: "ok",
				children: "已传"
			}) : /* @__PURE__ */ jsx(Badge, { children: optional ? "选填" : "待传" }),
			extra || null,
			/* @__PURE__ */ jsx("span", {
			...
			fileName ? /* @__PURE__ */ jsx(DocActions, {
				id: id || "pending",
				kind,
				fileName,
				onDeleted
	...
	return /* @__PURE__ */ jsx(Need, {
		...
		children: /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs(Button, {
								...
								children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), " 新增报销"]
							})
						]
					})]
				}),
						...
						/* @__PURE__ */ jsxs("label", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: [/* @__PURE__ */ jsx("option", {
									value: "all",
									children: "全部"
								}), claimantOpts.map((n) => /* @__PURE__ */ jsx("option", {
									value: n,
									children: n
								}, n))]
							})]
				...
				selected.length ? /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx(Field, {
									label: "报销人 *（谁来报）",
									children: /* @__PURE__ */ jsx(NameInput, {
								...
								/* @__PURE__ */ jsx(Field, {
									...
									children: /* @__PURE__ */ jsx("select", {
										...
										children: PAY_METHODS.map((m) => /* @__PURE__ */ jsx("option", { children: m }, m))
									})
								}),
								/* @__PURE__ */ jsxs("div", {
				...
				editing ? /* @__PURE__ */ jsx(ExpenseEditor, {
					draft: editing,
					creating,
					all: list,
					payees,
				...
				/* @__PURE__ */ jsx(WideTable, {
					...
					children: /* @__PURE__ */ jsxs("table", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("tbody", { children: [shown.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
								colSpan: 13,
								...
								return /* @__PURE__ */ jsxs("tr", {
									...
									children: [
										...
										/* @__PURE__ */ jsx("td", {
											className: "p-2 text-xs",
											onClick: (ev) => ev.stopPropagation(),
											children: e.voucherFileName ? /* @__PURE__ */ jsx(DocActions, {
												id: e.voucherId || e.id,
												kind: "expense",
												fileName: e.voucherFileName
											}) : e.payMethod === "现金" ? "—" : /* @__PURE__ */ jsx("span", {
												className: "text-warn",
												children: "缺"
											})
										}),
										/* @__PURE__ */ jsx("td", {
											className: "p-2 text-xs",
											onClick: (ev) => ev.stopPropagation(),
											children: e.payoutFileName ? /* @__PURE__ */ jsxs("div", {
												className: "flex flex-wrap items-center gap-1",
												children: [/* @__PURE__ */ jsx(DocActions, {
													id: e.payoutId || e.id,
													kind: "payout",
													fileName: e.payoutFileName
												}), sib > 1 ? /* @__PURE__ */ jsxs("span", {
											...
											}) : e.status === "已报销" && (e.payoutMethod || "转账") !== "现金" ? /* @__PURE__ */ jsx("span", {
												className: "text-warn",
												children: "缺打款"
											}) : "—"
										}),
							...
							shown.length ? /* @__PURE__ */ jsx("tfoot", { children: /* @__PURE__ */ jsxs("tr", {
		...
		}), /* @__PURE__ */ jsx(ExpenseSheets, { rows: printRows })] })
	});
}
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("section", {
			...
			children: [
				...
				siblings.length > 1 ? /* @__PURE__ */ jsxs("p", {
					...
					children: [
						...
						/* @__PURE__ */ jsx(Field, {
							...
							children: /* @__PURE__ */ jsxs("select", {
								...
								children: [/* @__PURE__ */ jsx("option", { children: "未报销" }), /* @__PURE__ */ jsx("option", { children: "已报销" })]
							})
						}),
						/* @__PURE__ */ jsx(Field, {
							label: "备注",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(VoucherSlot, {
						title: "购买凭证",
						...
						extra: existingVouchers.length ? /* @__PURE__ */ jsxs("select", {
							...
							children: [/* @__PURE__ */ jsx("option", {
								value: "",
								children: "单独上传"
							}), existingVouchers.map((e) => /* @__PURE__ */ jsx("option", {
								value: e.voucherId,
						...
						extra: existingPayouts.length ? /* @__PURE__ */ jsxs("select", {
							className: "h-8 max-w-40 rounded-sm border border-line bg-surface px-2 text-[11px]",
							value: c.payoutId || "",
							onChange: (e) => {
								const id = e.target.value;
							...
							children: [/* @__PURE__ */ jsx("option", {
								value: "",
								children: "单独上传"
							}), existingPayouts.map((e) => /* @__PURE__ */ jsxs("option", {
								value: e.payoutId,
								children: [
									e.payoutFileName,
									"（",
			...
			children: [
				...
				/* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { children: [
						...
						"开户行",
						"打款账户"
					].map((col) => /* @__PURE__ */ jsx("th", {
						className: "border border-black px-1 py-1 font-medium",
						children: col
					}, col)) }) }), /* @__PURE__ */ jsx("tbody", { children: /* @__PURE__ */ jsx("tr", { children: [
						claimants.join("、") || "—",
						forWhoms.join("、") || "—",
						banks.join("、") || "—",
						cards.join("、") || "—"
					].map((v, i) => /* @__PURE__ */ jsx("td", {
				...
				/* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { children: [
						...
						className: "border border-black px-1 py-1 font-medium",
						children: col
					}, col)) }) }), /* @__PURE__ */ jsxs("tbody", { children: [rows.map((e, i) => /* @__PURE__ */ jsx("tr", { children: [
						i + 1,
						e.name,
						e.period || e.date,
						money(e.amount),
					...
					].map((v, k) => /* @__PURE__ */ jsx("td", {
						className: "border border-black px-1 py-1",
						children: v
					}, k)) }, e.id)), /* @__PURE__ */ jsx("tr", { children: [
						"合计",
						"",
						"",
						money(total),
