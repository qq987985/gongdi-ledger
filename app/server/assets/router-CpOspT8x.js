...
import { a as resolveTenant, n as handleAuthPost, o as withTenant, t as ensureAccounts } from "./accounts.server-B9DHe7Ux.js";
...
var $$splitComponentImporter$10 = () => import("./attendance-CsTHv6vU.js");
...
var $$splitComponentImporter = () => import("./settings-DB_S3fgK.js");
...
const Route$14 = createFileRoute("/api/auth")({ server: { handlers: {
	GET: async ({ request }) => {
		...
		const { resolveTenant: resolveTenant$1, publicUser, memberList } = await import("./accounts.server-DxW6NZHV.js");
