...
import { f as confirmRemoveYear, v as monthStatus, y as nextYear } from "./contracts-DevrMU-0.js";
import { n as useApp } from "./store-CdYwLeDo.js";
import { i as toast } from "./audit-BAusgva9.js";
import { i as pullNasLedger, n as flushPendingLedger, r as nasEnabled } from "./nas-sync-2amb6NFF.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-DJux1KKr.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-DJux1KKr.js");
					await detectNas();
