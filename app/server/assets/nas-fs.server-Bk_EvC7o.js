...
async function pruneOldLogs(dir) {
	try {
		...
		for (const name of selectExpiredLogs(names, /* @__PURE__ */ new Date(), parseKeepDays(process.env.LOG_KEEP_DAYS))) try {
			await unlink(join(dir, name));
		} catch {}
	} catch {}
}
async function writeLine(dir, line) {
...
async function seedTemplates() {
	...
	try {
		const excel = await import("./excel-DAoNDbGd.js");
...
export { savePhoto as A, findPhotoPath as C, removeDocFile as D, photoNameWritable as E, logServer as F, dataDir as M, persistOn as N, removePhoto as O, runWithBook as P, findDoc as S, photoFlags as T, writeAudit as _, isManagedBackupFile as a, adoptLegacyAssets as b, ledgerUnreadable as c, readAudit as d, readBookMeta as f, saveBackup as g, removeBookDir as h, backupKeepCount as i, scanPhotoFolder as j, saveDoc as k, listBookIds as l, readVersionText as m, appendAudit as n, ledgerRevisionOf as o, readLedger as p, auditUnreadable as r, ledgerRevisionValue as s, DEFAULT_BACKUP_KEEP as t, pruneBackups as u, writeBookMeta as v, isWritablePhotoDataUrl as w, docIdWritable as x, writeLedger as y };
