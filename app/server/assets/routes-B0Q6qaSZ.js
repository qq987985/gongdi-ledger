...
import { a as can, f as subscribePerms } from "./perms-D5IsG1Md.js";
import { a as money, t as cn } from "./utils-DqsA5Dz5.js";
import { u as derivedYears } from "./wage-BVBIWt51.js";
import { u as overAgeLabel } from "./contracts-FU2UPdFm.js";
import { n as useApp } from "./store-SQXLJqfK.js";
import "./audit-diff-BCw9WhZ-.js";
import { i as useCan, t as Can } from "./can-Cjz25VK8.js";
import { n as summarizeYear, r as teamRows, t as fallbackPayYear } from "./attendance-summary-BQ9QXRJ_.js";
import { t as contractPayable } from "./contracts-totals-DKZVKfGF.js";
...
function Home() {
	...
	const { should, paid, proxyAmt, pendingAmt, proxyCount: proxy, filledMonths: monthsFilled } = import_react.useMemo(() => summarizeYear({
		people,
		attendance,
		payments,
		year,
	...
	const rows = import_react.useMemo(() => teamRows(people), [people]);
	...
	const contractPay = contractPayable(contracts.filter((c) => c.year === year), contractEntries);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				className: "hero-banner rounded-xl bg-gradient-to-r from-accent-strong via-accent to-violet-500 p-5 text-white shadow-panel",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							].map((h) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Can, {
								perm: h.perm,
			...
			p.pendingAmt ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(QuickHiddenNote, {}),
						p.over > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OverAges, {
...
function Quick({ to, title, desc, perm }) {
...
function OverAges({ people, count, className }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mb-1.5 text-xs font-semibold text-warn",
				children: "超龄人员名单"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
				className: "max-h-64 space-y-1 overflow-y-auto",
				children: people.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
					className: "flex flex-wrap items-center justify-between gap-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [p.name, p.gender ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "ml-1 text-muted",
						children: p.gender
					}) : null] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-wrap items-center gap-x-3 gap-y-0.5 font-mono tabular-nums",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: fmtBirthday(p.birthday) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: p.idCard ? maskIdCard(p.idCard) : "—" })]
					})]
				}, p.id))
			})]
		}) : null]
