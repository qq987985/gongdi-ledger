import { A as runWithBook, O as dataDir, c as readBookMeta, j as logServer, k as persistOn, m as writeBookMeta, o as listBookIds, t as appendAudit } from "./nas-fs.server-DwUEkIQu.js";
import { c as hasPerm, i as PRESETS, o as canManageLedger, s as canWriteLedger, t as ALL_PERMS } from "./perms-DmHFMYGr.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-DR28eOmY.js");
