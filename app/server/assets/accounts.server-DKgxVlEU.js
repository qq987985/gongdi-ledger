import { D as writeBookMeta, b as runWithBook, d as persistOn, i as dataDir, k as logServer, m as readBookMeta, n as appendAudit, u as listBookIds } from "./nas-fs.server-C59QPQlV.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-Bedh5TEE.js");
