import { S as writeBookMeta, a as listBookIds, h as runWithBook, l as readBookMeta, n as dataDir, o as persistOn, t as appendAudit } from "./nas-fs.server-BfxLYYRi.js";
import { i as PRESETS, o as canWriteLedger, s as hasPerm, t as ALL_PERMS } from "./perms-DQTE-mZW.js";
import { o as uid } from "./utils-CBhPqRT8.js";
import { i as hashPassword } from "./auth-eu_OLOze.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-BrHAl9vZ.js");
