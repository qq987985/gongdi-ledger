...
import { a as normalizeEntry, c as normalizeIdDate, g as localToday, h as derivedYears, o as splitLegacyReceipts, u as parseIdCard, v as nextYear } from "./contracts-DonCYL5F.js";
import { n as logOp } from "./audit-BsW4IHpo.js";
...
const useApp = create()(persist((set, get) => ({
	...
	replaceContracts: (contracts, entries) => {
		...
		set({
			contracts,
			contractEntries: (entries ?? get().contractEntries).filter((e) => keepIds.has(e.contractId))
		});
	},
	upsertExpense: (row) => {
...
export { useApp as n, emptyState as t };
