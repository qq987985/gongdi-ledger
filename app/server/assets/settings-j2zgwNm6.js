import { n as WinUpdate } from "./shell-CeT3OT3c.js";
...
import { i as pushNasBackup, n as nasEnabled, r as pullNasLedger } from "./nas-sync-CCPCEHMg.js";
...
import { t as clearAllPhotos } from "./photos-CsTkQ9RH.js";
...
function UiStyleCard() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-1 text-sm text-muted",
				children: "喜欢哪套用哪套，随时切换；只影响显示，不动数据。"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-4 flex flex-wrap gap-2",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "新版：图标导航 + 仪表盘总览；原版：左边完整菜单 + 统计卡总览。"
			})
		]
	});
}
