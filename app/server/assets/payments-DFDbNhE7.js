...
import { a as toggleSel, i as money, n as confirmBatchDelete } from "./utils-CBhPqRT8.js";
import { f as dateYear, g as parseDateYmd, p as derivedYears } from "./contracts-BSLoZOKY.js";
...
import { a as PaymentImport, s as TplLink } from "./excel-import-CQOZMU9b.js";
...
function PaymentsPage() {
	...
	const [fillDate, setFillDate] = React.useState(() => (/* @__PURE__ */ new Date()).toISOString().slice(0, 10));
	...
	return /* @__PURE__ */ jsx(Need, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
					...
					children: [
						...
						/* @__PURE__ */ jsxs("select", {
							...
							children: [/* @__PURE__ */ jsx("option", {
								value: "all",
								children: "全部发放方"
							}), batches.map((b) => /* @__PURE__ */ jsx("option", {
								value: b,
								children: b
							}, b))]
						}),
						/* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								["paid", "已发放"]
							].map(([k, label$1]) => /* @__PURE__ */ jsx("button", {
								type: "button",
				...
				/* @__PURE__ */ jsx(WideTable, {
					...
					children: /* @__PURE__ */ jsxs("table", {
						...
						children: [/* @__PURE__ */ jsx("thead", {
							...
							children: "暂无发放记录"
						}) }) : null, pageRows.map((p, i) => /* @__PURE__ */ jsxs("tr", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("td", {
									className: "p-3",
									children: p.date || /* @__PURE__ */ jsx(Badge, {
										tone: "warn",
										children: "待发放"
									})
								}),
								...
								/* @__PURE__ */ jsxs("td", {
									className: "p-3",
									children: [p.receiver, p.owner !== p.receiver ? /* @__PURE__ */ jsx(Badge, {
										tone: "warn",
										className: "ml-2",
										children: "代收"
									}) : /* @__PURE__ */ jsx(Badge, {
				...
				editing ? /* @__PURE__ */ jsx(PaymentEditor, {
					draft: editing,
					creating,
					ownerNames,
					receiverNames,
				...
				byOwner.length > 0 ? /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						}), /* @__PURE__ */ jsx("tbody", { children: byOwner.slice(0, 12).map(([name, amt]) => /* @__PURE__ */ jsxs("tr", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsx(Label, { children: "实际收款人（入账）" }),
						/* @__PURE__ */ jsx(Input, {
							className: "mt-2 h-11",
						...
						/* @__PURE__ */ jsx("datalist", {
							id: "pay-edit-owners",
							children: ownerNames.map((n) => /* @__PURE__ */ jsx("option", { value: n }, n))
						})
					] }),
					/* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsx(Label, { children: "收款人（代收可填别人）" }),
						/* @__PURE__ */ jsx(Input, {
							className: "mt-2 h-11",
						...
						/* @__PURE__ */ jsx("datalist", {
							...
							children: receiverNames.map((n) => /* @__PURE__ */ jsx("option", { value: n }, n))
						})
					] }),
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "发放日期（空=待发放）" }), /* @__PURE__ */ jsx(Input, {
						className: "mt-2 h-11",
						type: "date",
						value: parseDateYmd(c.date) || c.date || "",
						onChange: (e) => patch("date", e.target.value)
					})] }),
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "发放金额（元）" }), /* @__PURE__ */ jsx(Input, {
						className: "mt-2 h-11",
						type: "number",
						value: c.amount || "",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx(Label, { children: "发放方" }),
							/* @__PURE__ */ jsx(Input, {
								className: "mt-2 h-11",
							...
							/* @__PURE__ */ jsx("datalist", {
								id: "pay-edit-sources",
								children: sources.map((n) => /* @__PURE__ */ jsx("option", { value: n }, n))
							})
						]
					}),
					/* @__PURE__ */ jsxs("div", {
						className: "md:col-span-2",
						children: [/* @__PURE__ */ jsx(Label, { children: "备注" }), /* @__PURE__ */ jsx(Input, {
							className: "mt-2 h-11",
							value: c.remark,
