...
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-CCPCEHMg.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-BezoxVsr.js");
				await startNasSync();
			} catch {}
...
function AppShell() {
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-BezoxVsr.js");
					await detectNas();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("app-bg min-h-screen min-h-dvh overflow-x-hidden text-ink", uiStyle === "classic" && "theme-classic"),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [uiStyle === "classic" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				...
				className: "no-print sticky top-0 hidden h-screen w-[72px] shrink-0 flex-col items-center gap-1 border-r border-line bg-surface/90 py-4 backdrop-blur md:flex",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					uiStyle === "v2" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						className: "no-print sticky top-0 z-30 hidden items-center gap-3 border-b border-line bg-surface/80 px-6 py-3 backdrop-blur md:flex",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Brand, {
								year,
								pathname
