...
import "./excel-B3YzgRRg.js";
import { t as useApp } from "./store-DN67JpqK.js";
import "./nas-sync-Drf555ZD.js";
import { d as setDoc, l as renameFile, n as DocActions } from "./doc-actions-C9f_qhZb.js";
...
import { a as InsuranceMemberImport, c as TplLink } from "./excel-import-WO8l530Q.js";
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: [selected.policyNo, selected.name ? ` · ${selected.name}` : ""]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-3 grid grid-cols-2 gap-x-6 gap-y-1 text-sm",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["购买公司：", selected.buyer || "—"] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["保险公司：", selected.company || "—"] }),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["保险期天数：", periodDays || "—"] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
										"每人保费：",
										money(premiumPerPerson),
										" 元"
									] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["人数：", headcount] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
										"总保费：",
										money(totalPremium),
										" 元"
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
										"每人每天：",
										money(Math.round(perPersonDaily * 100) / 100),
										" 元"
									] })
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
								className: "mt-4 w-full border-collapse text-center text-xs",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: [
									...
									children: h
								}, h)) }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: [...policyMembers].sort((a, b) => (a.startDate || "").localeCompare(b.startDate || "") || a.name.localeCompare(b.name, "zh")).map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
