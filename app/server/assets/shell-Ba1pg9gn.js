...
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-DZKgDj3q.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-LnFMBC6b.js");
				await startNasSync();
			} catch {}
...
function AppShell() {
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-LnFMBC6b.js");
					await detectNas();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("app-bg min-h-screen min-h-dvh overflow-x-hidden text-ink", uiStyle === "classic" && "theme-classic", uiStyle === "apple" && "theme-apple"),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [uiStyle === "classic" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				...
				className: cn("no-print sticky top-0 hidden h-screen w-[72px] shrink-0 flex-col items-center gap-1 border-r py-4 md:flex", uiStyle === "apple" ? "border-white/50 bg-white/55 backdrop-blur-2xl" : "border-line bg-surface/90 backdrop-blur"),
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					uiStyle !== "classic" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						className: cn("no-print sticky top-0 z-30 hidden items-center gap-3 border-b px-6 py-3 backdrop-blur md:flex", uiStyle === "apple" ? "border-white/50 bg-white/50 backdrop-blur-2xl" : "border-line bg-surface/80"),
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Brand, {
								year,
								pathname
