...
import { a as xlsx_exports, t as readSync$1 } from "./xlsx-oOqGg--s.js";
import { C as monthPay, S as hasWork, a as normalizeEntry, c as normalizeIdDate, i as normalizeContractStatus, m as daysBetween, n as contractRollup, o as splitLegacyReceipts, s as splitTax, u as parseIdCard, v as parseDateYmd, x as getWageAt, y as paymentsInYear } from "./contracts-_5fVbN-L.js";
...
function buildFullWorkbook(args) {
	...
	if (insurancePolicies.length) {
		...
		for (const p of insurancePolicies) paoa.push([
			p.policyNo,
			p.name,
			p.buyer,
			p.company,
