...
import { S as wageLabel, b as monthPay, l as overAgeLabel, p as derivedYears, x as parseOtRule, y as hasWork } from "./contracts-C1vBmiZ8.js";
import "./excel-DljZk7Qw.js";
import { t as useApp } from "./store-C5SZ1jtR.js";
import "./nas-sync-YEjyDlzb.js";
import { a as Check, n as PhotoSlot } from "./photo-slot-CD6IrILF.js";
...
function QueryPage() {
	...
	const [name, setName] = import_react.useState(people[0]?.name || "");
	const [printNames, setPrintNames] = import_react.useState(people[0]?.name ? [people[0].name] : []);
