...
import { a as toggleSel, n as confirmBatchDelete, o as uid } from "./utils-CBhPqRT8.js";
import { S as wageLabel, c as normalizeIdDate, g as parseDateYmd, l as overAgeLabel, u as parseIdCard, x as parseOtRule } from "./contracts-BSLoZOKY.js";
...
import { n as Need, t as Can } from "./can-BfltFJNf.js";
import "./file-pick-BdsLRyGI.js";
import { o as PeopleImport, s as TplLink } from "./excel-import-CQOZMU9b.js";
import { t as Badge } from "./badge-DFIkao3U.js";
import "./photos-CvRcX5fq.js";
import { i as usePhotoFlags, n as PhotoSlot, r as ScanPhotosButton } from "./photo-slot-D_u25i8s.js";
...
function PeoplePage() {
	...
	const flags = usePhotoFlags(React.useMemo(() => people.map((p) => p.name), [people]), photoTick);
			...
			children: [
				/* @__PURE__ */ jsxs("header", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
						...
						children: [
							...
							/* @__PURE__ */ jsx(Can, {
								perm: "import.use",
								children: /* @__PURE__ */ jsx(PeopleImport, {})
							}),
							/* @__PURE__ */ jsx(Can, {
								perm: "people.edit",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						selected.length > 0 ? /* @__PURE__ */ jsx(Can, {
							perm: "people.delete",
				...
				editing ? /* @__PURE__ */ jsx(PersonEditor, {
					person: editing,
					creating,
					refresh: photoTick,
					onClose: closeEditor,
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						form.payType === "month" ? /* @__PURE__ */ jsx(Field, {
							label: "月工资",
							required: true,
						...
						/* @__PURE__ */ jsx(Field, {
							...
							children: /* @__PURE__ */ jsx(DateFill, {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(Input, {
				...
				title: "选日期",
				children: [/* @__PURE__ */ jsx(CalendarDays, { className: "size-4" }), /* @__PURE__ */ jsx("input", {
					type: "date",
...
function Field({ label, children, className, required, error, hint }) {
	return /* @__PURE__ */ jsxs("div", {
		className,
		children: [
			/* @__PURE__ */ jsxs(Label, { children: [label, required ? /* @__PURE__ */ jsx("span", {
