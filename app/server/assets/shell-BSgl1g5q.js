...
import { a as can, l as setLivePerms, n as NAV_PERM, u as subscribePerms } from "./perms-BlHKQb24.js";
...
import { _ as nextYear, f as confirmRemoveYear, g as monthStatus } from "./contracts-_5fVbN-L.js";
import { t as useApp } from "./store-BR_FoMNL.js";
import { n as toast } from "./dist-CqIYJTgr.js";
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-BHwOTS0w.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-5hkScPWX.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-5hkScPWX.js");
					await detectNas();
