import { S as writeBookMeta, a as listBookIds, h as runWithBook, l as readBookMeta, n as dataDir, o as persistOn, t as appendAudit } from "./nas-fs.server-D9r5c4RV.js";
import { i as PRESETS, o as canWriteLedger, s as hasPerm, t as ALL_PERMS } from "./perms-CDZPEZ8n.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-Dn0Bezn4.js");
