...
import { _ as nextYear, f as confirmRemoveYear, g as monthStatus } from "./contracts-Bm8eyOQk.js";
import { t as useApp } from "./store-Dl6VldK8.js";
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-D4EOa45g.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-CvxF7_gT.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-CvxF7_gT.js");
					await detectNas();
