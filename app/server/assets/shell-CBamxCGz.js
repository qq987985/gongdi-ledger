...
import { n as nasEnabled, r as pullNasLedger } from "./nas-sync-BMXgNVhS.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-D5R4QFSl.js");
				await startNasSync();
			} catch {}
...
function AppShell() {
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-D5R4QFSl.js");
					await detectNas();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "app-bg min-h-screen min-h-dvh overflow-x-hidden text-ink",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex",
