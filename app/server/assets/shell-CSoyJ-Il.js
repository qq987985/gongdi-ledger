...
import { _ as monthStatus, f as confirmRemoveYear, v as nextYear } from "./contracts-DonCYL5F.js";
import { n as useApp } from "./store-DKxfgXiP.js";
import { i as toast } from "./audit-BAusgva9.js";
import { i as pullNasLedger, n as flushPendingLedger, r as nasEnabled } from "./nas-sync-Bwi78ByE.js";
...
function useHydrateStore() {
	import_react.useEffect(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-Dt2bFWrE.js");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger: pullNasLedger$1 } = await import("./nas-sync-Dt2bFWrE.js");
					await detectNas();
