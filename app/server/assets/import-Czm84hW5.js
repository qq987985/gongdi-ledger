...
import "./store-SQXLJqfK.js";
import "./audit-diff-BCw9WhZ-.js";
import "./file-pick-C7mO9xHH.js";
import "./button-GV790FWO.js";
import "./input-zpuDUNdP.js";
import { n as Need } from "./can-Cjz25VK8.js";
import { c as TplLink, i as FullBookImport, n as ContractImport, o as PaymentImport, r as ExpenseImport, s as PeopleImport, t as AttendanceImport } from "./excel-import-B1XcuBh9.js";
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "font-semibold",
							children: "导入整本台账 / 从备份恢复"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-1 text-sm text-muted",
							children: [
								"一次写入人员、各年月考勤、发放、报销、合同+明细、保险+参保人 ——",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "「设置 → 数据 → 立即备份 Excel」生成的备份文件直接用这里恢复" }),
								"（备份文件里含合同 5 张表）。 同键记录（同名人员 / 同保单号 / 重复的发放、报销、合同）会跳过、现有数据保留； 同一人同一月的考勤会用文件里的那一行覆盖； 影像附件（证件照、合同扫描件、报销凭证）不在 Excel 口径内，恢复后要人工核对文件还在不在。"
							]
						}),
