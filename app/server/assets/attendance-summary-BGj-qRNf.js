import { A as derivedYears, I as paymentsInYear, N as monthStatus, R as hasContent, b as nameKey, d as monthPay, p as round2, u as getWageAt, x as ownerKey } from "./contracts-CNGvTFF_.js";
import { n as groupBuckets } from "./buckets-CVtUoKqY.js";
import { i as isPaid, o as isPending, s as isProxyPaid } from "./payments-stats-7VeBWbav.js";
...
function summarizeYear(args) {
	...
	const orphanRows = [...orphans.entries()].map(([name, amount]) => {
		...
		return {
			person: people.find((p) => nameKey(p.name) === name) ?? {
				id: `pay-only:${name}`,
				name,
				team: "",
				personNo: "",
