	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [uiStyle === "classic" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				...
				className: cn("no-print sticky top-0 hidden h-screen w-[72px] shrink-0 flex-col items-center gap-1 border-r py-4 md:flex", uiStyle === "apple" ? "border-white/50 bg-white/55 backdrop-blur-2xl" : uiStyle === "movie" ? "border-white/10 bg-white/5 backdrop-blur-2xl" : "border-line bg-surface/90 backdrop-blur"),
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					uiStyle !== "classic" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						className: cn("no-print sticky top-0 z-30 hidden items-center gap-3 border-b px-6 py-3 backdrop-blur md:flex", uiStyle === "apple" ? "border-white/50 bg-white/50 backdrop-blur-2xl" : uiStyle === "movie" ? "border-white/10 bg-white/5 backdrop-blur-2xl" : "border-line bg-surface/80"),
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Brand, {
								year,
								pathname
