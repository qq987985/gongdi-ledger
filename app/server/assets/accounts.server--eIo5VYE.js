import { F as logServer, M as dataDir, N as persistOn, P as runWithBook, f as readBookMeta, l as listBookIds, n as appendAudit, v as writeBookMeta } from "./nas-fs.server-BSWxSjvG.js";
...
async function handleAuthPost(request) {
	...
	if (op === "deleteBook") {
		...
		await writeFileShape(data);
		const { removeBookDir } = await import("./nas-fs.server-Dk0f-KKu.js");
