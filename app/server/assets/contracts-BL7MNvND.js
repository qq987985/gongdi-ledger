...
import { a as toggleSel, i as money, n as confirmBatchDelete, o as uid } from "./utils-CBhPqRT8.js";
import { a as normalizeEntry, n as contractRollup, r as emptyContract, t as CONTRACT_STATUSES } from "./contracts-BSLoZOKY.js";
import { s as buildContractWorkbook } from "./excel-D3rRBCuB.js";
...
import { n as WideTable, r as usePager, t as ThHint } from "./wide-table-BUKe7FLR.js";
import { n as Need } from "./can-BfltFJNf.js";
import { n as FilePick } from "./file-pick-BdsLRyGI.js";
import { n as ContractImport } from "./excel-import-CQOZMU9b.js";
import { a as prepareNamedFile, c as removeDoc, i as invoiceBase, l as reportBase, n as DocActions, o as receiptSubBase, s as receiptWorkerBase, u as setDoc } from "./doc-actions-CSEe6Rec.js";
...
function MiniTable({ title, heads, rows, empty }) {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { children: heads.map((h) => /* @__PURE__ */ jsx("th", {
				className: "border border-black px-1 py-1 font-medium",
				children: h
			}, h)) }) }), /* @__PURE__ */ jsx("tbody", { children: rows.map((r, i) => /* @__PURE__ */ jsx("tr", { children: r.map((cell, j) => /* @__PURE__ */ jsx("td", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsxs("strong", { children: [reportLabel, "合计："] }),
								"¥",
								money(reportVal)
							] }),
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("strong", { children: "应收：" }),
								"¥",
								money(roll.payable)
							] }),
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("strong", { children: "开票合计：" }),
								"¥",
								money(roll.invoice),
								"（不含税¥",
							...
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("strong", { children: "已付：" }),
								"¥",
								money(roll.receipt),
								"（代付¥",
							...
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("strong", { children: "合同未付：" }),
								"¥",
								money(roll.dueRemain)
							] }),
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("strong", { children: "剩余款：" }),
								"¥",
								money(roll.remain)
							] })
						]
...
function ContractsPage() {
	...
	return /* @__PURE__ */ jsx(Need, {
			...
			children: [
				/* @__PURE__ */ jsxs("header", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
						...
						children: [
							"点表格里的合同名称，页面滚到下方，",
							/* @__PURE__ */ jsx("strong", { children: "保存合同信息正下方有虚线框「合同电子版」" }),
							"。有文件就是有合同，没传就是无合同；原因写在备注里。报量可选",
							/* @__PURE__ */ jsx("strong", { children: "含税" }),
							"或",
							/* @__PURE__ */ jsx("strong", { children: "不含税" }),
							"。"
						]
					})] }), /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs(Button, {
								...
								children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), " 新增合同"]
							})
						]
					})]
				}),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("label", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: [/* @__PURE__ */ jsx("option", {
									value: "all",
									children: "全部"
								}), CONTRACT_STATUSES.map((s) => /* @__PURE__ */ jsx("option", {
									value: s.id,
									children: s.label
								}, s.id))]
							})]
						...
						selected.length ? /* @__PURE__ */ jsxs(Button, {
							variant: "danger",
							type: "button",
				...
				editing ? /* @__PURE__ */ jsx(ContractEditor, {
					draft: editing,
					creating,
				...
				/* @__PURE__ */ jsx(WideTable, {
					...
					children: /* @__PURE__ */ jsxs("table", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("tbody", { children: [list.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
								colSpan: 20,
								...
								return /* @__PURE__ */ jsxs("tr", {
									...
									children: [
										...
										/* @__PURE__ */ jsx("td", {
											...
											children: c.scanFileName ? /* @__PURE__ */ jsx(Badge, {
												tone: "ok",
												children: "有"
											}) : /* @__PURE__ */ jsx(Badge, { children: "无" })
										}),
										/* @__PURE__ */ jsx("td", {
											className: "p-2",
							...
							list.length ? /* @__PURE__ */ jsx("tfoot", { children: /* @__PURE__ */ jsxs("tr", {
		...
		}), /* @__PURE__ */ jsx(ContractStatementSheets, { items: printItems })] })
	});
}
function sumTip(n) {
	return `本表 ${n} 笔`;
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						className: "btn-row",
						children: [
							c.scanFileName ? /* @__PURE__ */ jsx(Badge, {
								tone: "ok",
								children: "有合同"
							}) : /* @__PURE__ */ jsx(Badge, { children: "无合同" }),
							/* @__PURE__ */ jsx(Button, {
								variant: "outline",
								type: "button",
								onClick: onCancel,
					...
					children: [
						...
						/* @__PURE__ */ jsx(Field, {
							...
							children: /* @__PURE__ */ jsx("select", {
								...
								children: CONTRACT_STATUSES.map((s) => /* @__PURE__ */ jsx("option", {
									value: s.id,
									children: s.label
								}, s.id))
							})
...
function ReportBook({ contract, entries, disabled, onAdd, onRemove }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(EntryRows, {
				entries,
				title: "报量",
				onRemove,
				render: (e) => /* @__PURE__ */ jsxs(Fragment, { children: [
					/* @__PURE__ */ jsxs("div", {
...
function EntryRows({ entries, title, onRemove, render }) {
	return /* @__PURE__ */ jsxs("ul", {
		...
		children: [entries.length === 0 ? /* @__PURE__ */ jsx("li", {
			className: "text-muted",
			children: "暂无"
		}) : null, entries.slice().sort((a, b) => (a.date || "").localeCompare(b.date || "")).map((e) => /* @__PURE__ */ jsxs("li", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				})] }), contract.scanFileName ? /* @__PURE__ */ jsx(Badge, {
					tone: "ok",
					children: "有合同"
				}) : /* @__PURE__ */ jsx(Badge, { children: "无合同" })]
			}),
			/* @__PURE__ */ jsx(FilePick, {
				kind: "file",
			...
			contract.scanFileName ? /* @__PURE__ */ jsx("div", {
