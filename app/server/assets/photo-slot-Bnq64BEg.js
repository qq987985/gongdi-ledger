...
import { n as Copy, t as Download } from "./download-sOIPPxKy.js";
import { t as DropSurface } from "./file-pick-sYj_heGl.js";
import { n as toast } from "./dist-DfB6JCQe.js";
import { t as Button } from "./button-CtK1BncN.js";
import { a as fileToDataUrl, c as scanPhotoFolder, i as downloadPhoto, l as setPhoto, n as copyPhoto, o as getPhoto, r as deletePhoto, s as listPhotoFlags } from "./photos-DEnDYmxo.js";
...
function IdCardSlot({ name, compact, onChanged }) {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Camera, { className: "mr-0.5 size-3.5" }), front ? "换正面" : "正面"]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					type: "button",
					disabled: busy,
					className: cn(btnFill, !back && "opacity-70"),
					onClick: () => backRef.current?.click(),
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Camera, { className: "mr-0.5 size-3.5" }), back ? "换反面" : "反面"]
				})]
			}),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		compactView,
		front || back ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mt-2 flex items-center justify-center gap-3",
			children: [front ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				onClick: () => {
					setFace("front");
					setOpen(true);
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					src: front,
					alt: "身份证正面",
					className: "h-20 rounded border border-line object-contain hover:border-accent"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "mt-1 block text-[10px] text-muted",
					children: "正面"
				})]
			}) : null, back ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				onClick: () => {
					setFace("back");
					setOpen(true);
		...
		front || back ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			type: "button",
			onClick: () => setOpen(true),
			className: "mt-2 block text-xs text-accent hover:underline",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Expand, { className: "mr-1 inline size-3" }), " 放大查看"]
		}) : null,
...
function SinglePhotoSlot({ name, kind, label, compact, onChanged }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			url && !compact ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				onClick: () => setOpen(true),
