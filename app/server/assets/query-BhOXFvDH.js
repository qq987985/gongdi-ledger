...
import { i as money, r as copyText } from "./utils-CBhPqRT8.js";
import { S as wageLabel, b as monthPay, l as overAgeLabel, p as derivedYears, x as parseOtRule, y as hasWork } from "./contracts-BSLoZOKY.js";
...
import { n as DocActions } from "./doc-actions-CSEe6Rec.js";
import { t as Badge } from "./badge-DFIkao3U.js";
import { i as ymKey, n as monthsInRange, r as rangeLabel, t as YmPick } from "./ym-pick-Nze9YmJM.js";
import "./photos-CvRcX5fq.js";
import { n as PhotoSlot } from "./photo-slot-D_u25i8s.js";
...
function CopyField({ label, value, mono = false }) {
	...
	return /* @__PURE__ */ jsxs("button", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: ok ? /* @__PURE__ */ jsx(Check, { className: "size-4" }) : /* @__PURE__ */ jsx(Copy, { className: "size-4" })
		})]
	});
}
...
function PayslipSheets({ slips, rangeLabel: label, showPays }) {
	return /* @__PURE__ */ jsx("div", {
		...
		children: slips.map((s) => /* @__PURE__ */ jsxs("article", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", { children: ["姓名：", s.person.name] }),
						/* @__PURE__ */ jsxs("div", { children: ["班组：", s.person.team || "—"] }),
						/* @__PURE__ */ jsxs("div", { children: ["工资：", wageLabel(s.person)] }),
						/* @__PURE__ */ jsxs("div", { children: ["加班：", parseOtRule(s.person.otRule).label || "—"] })
					]
				}),
				s.months.length ? /* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { children: [
						...
						children: h
					}, h)) }) }), /* @__PURE__ */ jsxs("tbody", { children: [s.months.map((m) => /* @__PURE__ */ jsxs("tr", { children: [
						/* @__PURE__ */ jsxs("td", {
					...
					] }, `${m.year}-${m.month}`)), /* @__PURE__ */ jsxs("tr", { children: [
						/* @__PURE__ */ jsx("td", {
							className: "border border-black px-1 py-1 font-medium",
							children: "合计"
						}),
						...
						/* @__PURE__ */ jsx("td", { className: "border border-black px-1 py-1" })
					] })] })]
				}) : /* @__PURE__ */ jsx("p", {
				...
				showPays ? /* @__PURE__ */ jsxs("section", {
					className: "mt-4",
					children: [/* @__PURE__ */ jsx("div", {
						className: "text-sm font-medium",
						children: "打款记录"
					}), s.pays.length ? /* @__PURE__ */ jsxs("table", {
						...
						children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { children: [
							...
							className: "border border-black px-1 py-1 font-medium",
							children: h
						}, h)) }) }), /* @__PURE__ */ jsxs("tbody", { children: [s.pays.map((x, i) => /* @__PURE__ */ jsxs("tr", { children: [
							/* @__PURE__ */ jsx("td", {
								className: "border border-black px-1 py-1",
								children: x.date
							}),
						...
						] }, `${x.date}-${i}`)), /* @__PURE__ */ jsxs("tr", { children: [
							/* @__PURE__ */ jsx("td", {
								className: "border border-black px-1 py-1 font-medium",
								children: "已打款合计"
							}),
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", { children: "领款人签字：________________" }), /* @__PURE__ */ jsx("div", { children: "日期：______年____月____日" })]
				})
			]
		}, s.person.id))
	});
...
function QueryPage() {
	...
	const [printNames, setPrintNames] = React.useState(people[0]?.name ? [people[0].name] : []);
	...
	const p = people.find((x) => x.name === name);
	const span = React.useMemo(() => monthsInRange(fromY, fromM, toY, toM), [
		fromY,
		fromM,
		toY,
		toM
	...
	const slips = React.useMemo(() => buildSlips({
		people,
		names: printNames,
		span,
		attendance,
				...
				children: [
					/* @__PURE__ */ jsxs("header", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
							...
							children: people.map((x) => /* @__PURE__ */ jsx("option", { children: x.name }, x.id))
						})]
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
								...
								children: [
									...
									teams.map((t) => /* @__PURE__ */ jsx(Button, {
										variant: "outline",
										size: "sm",
										type: "button",
							...
							children: people.map((x) => /* @__PURE__ */ jsxs("label", {
					...
					p ? /* @__PURE__ */ jsxs(Fragment, { children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx(Badge, { children: p.team }),
								overAgeLabel(p.age, p.gender) === "超龄" ? /* @__PURE__ */ jsx(Badge, {
									tone: "warn",
									children: "超龄"
								}) : null
							]
									...
									children: /* @__PURE__ */ jsxs("table", {
										...
										children: [/* @__PURE__ */ jsx("thead", {
											...
											children: /* @__PURE__ */ jsxs("tr", { children: [
												...
												/* @__PURE__ */ jsx("th", { children: "出勤" }),
												/* @__PURE__ */ jsx("th", { children: "加班小时" }),
												/* @__PURE__ */ jsx("th", { children: "补助" }),
												/* @__PURE__ */ jsx("th", { children: "扣款" }),
												/* @__PURE__ */ jsx("th", { children: "加班费" }),
												/* @__PURE__ */ jsx("th", { children: "应发" }),
												/* @__PURE__ */ jsx("th", { children: "备注" })
											] })
										}), /* @__PURE__ */ jsxs("tbody", { children: [rows.map((r) => /* @__PURE__ */ jsxs("tr", {
										...
										}, `${r.year}-${r.month}`)), /* @__PURE__ */ jsxs("tr", {
						...
						/* @__PURE__ */ jsxs("section", {
							...
							children: [/* @__PURE__ */ jsxs("h3", {
								...
								children: [pays.length === 0 ? /* @__PURE__ */ jsx("li", {
									className: "text-muted",
									children: "该区间暂无"
								}) : null, pays.map((x) => /* @__PURE__ */ jsxs("li", {
						...
						/* @__PURE__ */ jsxs("section", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("ul", {
									...
									children: [(attendanceDocs || []).filter((d) => span.some((x) => x.year === d.year && x.month === d.month)).map((d) => /* @__PURE__ */ jsxs("li", {
									...
									}, d.id)), (attendanceDocs || []).filter((d) => span.some((x) => x.year === d.year && x.month === d.month)).length === 0 ? /* @__PURE__ */ jsx("li", {
										className: "text-muted",
