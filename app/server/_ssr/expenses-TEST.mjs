...
import { n as DocActions, p as prepareNamedFile, u as setDoc } from "./doc-actions-CoPSki7O.mjs";
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mini, { label: picked.length ? "已选合计" : "本表合计", hint: sumTip, value: totals.amount }),
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "p-3", children: "收款人" }),
									...
									pageRows.map((e, i) => {
										...
										return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "p-2 tabular-nums text-muted", children: (pager.page - 1) * pager.size + i + 1 }),
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "p-2", children: e.forWhom || "—" }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "p-2 text-xs", children: accountOf(e) || "—" }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
													className: "p-2",
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
													...
													}) : e.payMethod === "现金" ? "—" : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-warn", children: "缺" })
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
													className: "p-2 text-xs",
													onClick: (ev) => ev.stopPropagation(),
													children: e.payoutFileName ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [
															...
															sib > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "text-muted", children: ["·", sib, "笔"] }) : null
														]
													}) : e.status === "已报销" && (e.payoutMethod || "转账") !== "现金" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-warn", children: "缺打款" }) : "—"
												}),
								...
								shown.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tfoot", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "购买时间", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, { value: c.period, onChange: (e) => patch("period", e.target.value), placeholder: "如 2026/3月-12月 或 2026/4/9" }) }),
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(VoucherSlot, {
						...
						extra: existingVouchers.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "", children: "单独上传" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: ["报销人", "收款人", "开户行", "打款账户"].map((col) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
								className: "border border-black px-1 py-1 font-medium",
								children: col
							}, col)) }) }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: [
								claimants.join("、") || "—",
								forWhoms.join("、") || "—",
								banks.join("、") || "—",
								cards.join("、") || "—"
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
						className: "mt-2 w-full border-collapse text-center text-xs",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: ["序号", "项目", "购买时间", "金额", "备注", "票据"].map((col) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
								className: "border border-black px-1 py-1 font-medium",
								children: col
							}, col)) }) }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tbody", { children: [
