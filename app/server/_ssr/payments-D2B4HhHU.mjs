...
import { A as parseDateYmd, Q as toggleSel, Y as confirmBatchDelete, Z as money, b as derivedYears, n as useApp, y as dateYear } from "./router-D_p-605U2.mjs";
import { n as WideTable } from "./wide-table-D8rPvj0E.mjs";
import { i as PaymentImport, o as TplLink } from "./excel-import-RCA27lVp.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/payments-D2B4HhHU.js
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						...
						children: "按月份区间查，和「个人查询」一样。查单月就把起止设成同一个月。没日期的是待发放，不按月份丢掉。"
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									className: "p-3",
									children: p.date ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
										type: "date",
										className: "h-9 w-[10.5rem]",
										value: parseDateYmd(p.date) || p.date,
										onChange: (e) => patchPayments([p.id], { date: e.target.value })
									}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex flex-wrap items-center gap-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
											...
											value: "",
											onChange: (e) => {
												if (e.target.value) applyDate([p.id], e.target.value);
											}
										})]
									})
								}),
