...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-DxdzlCp3.js
...
function useHydrateStore() {
	(0, import_react.useEffect)(() => {
		(async () => {
			...
			try {
				const { startNasSync } = await import("./nas-sync-BdIeXt97.mjs");
				await startNasSync();
			} catch {}
	...
	async function refreshGate() {
		try {
			...
			if (!s.persist) setGate("app");
				...
				setGate("app");
				try {
					const { detectNas, pullNasLedger } = await import("./nas-sync-BdIeXt97.mjs");
					await detectNas();
					await pullNasLedger();
				} catch {}
			}
...
var $$splitComponentImporter$9 = () => import("./attendance-qfBQ5gkv.mjs");
var Route$23 = createFileRoute("/attendance")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./audit-uwDF_Ocw.mjs");
...
var Route$13 = createFileRoute("/api/audit")({ server: { handlers: {
	GET: async ({ request }) => {
		const { persistOn, readAudit } = await import("./nas-fs.server-huEdTgug.mjs");
	...
	POST: async ({ request }) => {
		const { persistOn, appendAudit } = await import("./nas-fs.server-huEdTgug.mjs");
		const { withTenant, resolveTenant } = await import("./accounts.server-DNyKCx-M.mjs");
	...
	PUT: async ({ request }) => {
		const { persistOn, readAudit, writeAudit } = await import("./nas-fs.server-huEdTgug.mjs");
		const { withTenant, resolveTenant } = await import("./accounts.server-DNyKCx-M.mjs");
		if (!persistOn()) return Response.json({ ok: false }, { status: 400 });
...
var Route$12 = createFileRoute("/api/auth")({ server: { handlers: {
	GET: async ({ request }) => {
		const { persistOn } = await import("./nas-fs.server-huEdTgug.mjs");
		...
		const { ensureAccounts, resolveTenant, publicUser, memberList } = await import("./accounts.server-DNyKCx-M.mjs");
	...
	POST: async ({ request }) => {
		...
		const { handleAuthPost } = await import("./accounts.server-DNyKCx-M.mjs");
		return handleAuthPost(request);
	}
} } });
var Route$11 = createFileRoute("/api/backup")({ server: { handlers: { POST: async ({ request }) => {
	const { persistOn, saveBackup } = await import("./nas-fs.server-huEdTgug.mjs");
	const { withTenant } = await import("./accounts.server-DNyKCx-M.mjs");
	if (!persistOn()) return Response.json({ ok: false }, { status: 400 });
...
var Route$10 = createFileRoute("/api/doc")({ server: { handlers: {
	GET: async ({ request }) => {
		const { persistOn, findDoc } = await import("./nas-fs.server-huEdTgug.mjs");
		const { withTenant } = await import("./accounts.server-DNyKCx-M.mjs");
	...
	PUT: async ({ request }) => {
		const { persistOn, saveDoc } = await import("./nas-fs.server-huEdTgug.mjs");
		const { withTenant } = await import("./accounts.server-DNyKCx-M.mjs");
		if (!persistOn()) return Response.json({ ok: false }, { status: 400 });
	...
	DELETE: async ({ request }) => {
		const { persistOn, removeDocFile } = await import("./nas-fs.server-huEdTgug.mjs");
		const { withTenant } = await import("./accounts.server-DNyKCx-M.mjs");
		if (!persistOn()) return Response.json({ ok: false }, { status: 400 });
		const url = new URL(request.url);
		const id = url.searchParams.get("id") || "";
...
var Route$8 = createFileRoute("/api/ledger")({ server: { handlers: {
	...
	PUT: async ({ request }) => {
		const { persistOn, writeLedger } = await import("./nas-fs.server-huEdTgug.mjs");
		const { withTenant } = await import("./accounts.server-DNyKCx-M.mjs");
...
var Route$7 = createFileRoute("/api/photo")({ server: { handlers: {
	GET: async ({ request }) => {
		const { persistOn, findPhotoPath } = await import("./nas-fs.server-huEdTgug.mjs");
		const { withTenant } = await import("./accounts.server-DNyKCx-M.mjs");
	...
	PUT: async ({ request }) => {
		const { persistOn, savePhoto } = await import("./nas-fs.server-huEdTgug.mjs");
		const { withTenant } = await import("./accounts.server-DNyKCx-M.mjs");
		if (!persistOn()) return Response.json({ ok: false }, { status: 400 });
		const body = await request.json();
	...
	DELETE: async ({ request }) => {
		const { persistOn, removePhoto } = await import("./nas-fs.server-huEdTgug.mjs");
		const { withTenant } = await import("./accounts.server-DNyKCx-M.mjs");
		if (!persistOn()) return Response.json({ ok: false }, { status: 400 });
		const url = new URL(request.url);
		const name = url.searchParams.get("name") || "";
...
var Route$5 = createFileRoute("/api/photo-flags")({ server: { handlers: {
	GET: async ({ request }) => {
		const { persistOn, photoFlags } = await import("./nas-fs.server-huEdTgug.mjs");
...
var Route$4 = createFileRoute("/api/photo-scan")({ server: { handlers: { POST: async ({ request }) => {
	const { persistOn, scanPhotoFolder, readLedger } = await import("./nas-fs.server-huEdTgug.mjs");
	const { withTenant } = await import("./accounts.server-DNyKCx-M.mjs");
...
var Route$2 = createFileRoute("/api/version")({ server: { handlers: { GET: async () => {
	const { readVersionText } = await import("./nas-fs.server-huEdTgug.mjs");
...
async function addYearAndRedirect(request, year) {
	const { persistOn, readLedger, writeLedger } = await import("./nas-fs.server-huEdTgug.mjs");
