...
import { $ as uid, d as parseContractWorkbook, f as parsePaymentSheet, n as useApp, p as parsePeopleSheet, u as parseAttendanceSheet } from "./router-D_p-605U2.mjs";
import { n as FilePick } from "./file-pick-BbqxzWa5.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/excel-import-RCA27lVp.js
...
function AttendanceImport() {
	...
	async function onFile(file) {
		...
		setPreview({
			...
			targetMonth: months.length === 1 ? months[0] : store.year === (/* @__PURE__ */ new Date()).getFullYear() ? (/* @__PURE__ */ new Date()).getMonth() + 1 : 1,
...
function FullBookImport() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilePick, {
		...
		onFile: async (file) => {
			if (!file) return;
			const { parseFullAttendanceWorkbook } = await import("../_libs/_3.mjs").then((n) => n.a);
