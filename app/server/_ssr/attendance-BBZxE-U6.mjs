...
import { E as Button, t as Input } from "./router-D_p-605U.mjs";
...
import { $ as uid, C as hasWork, E as nextYear, I as wageLabel, M as parseOtRule, N as paymentsInYear, Q as toggleSel, T as monthStatus, Y as confirmBatchDelete, Z as money, b as derivedYears, n as useApp, w as monthPay } from "./router-D_p-605U2.mjs";
import { c as renameFile, d as uniqueBase, n as DocActions, r as attendanceBase, u as setDoc } from "./doc-actions-C9CgIyQN.mjs";
import { n as WideTable } from "./wide-table-D8rPvj0E.mjs";
import { n as FilePick } from "./file-pick-BbqxzWa5.mjs";
import { o as TplLink, t as AttendanceImport } from "./excel-import-RCA27lVp.mjs";
import { n as Need } from "./can-gkGWV5bu.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/attendance-BBZxE-U6.js
...
function YearOverview({ onOpen, onAddYear, upcoming }) {
	...
	const fallbackYear = derivedYears({
		year,
		years: [year],
		attendance,
		payments
	...
	Object.fromEntries(people.map((p) => [p.name, p]));
	...
	const [sumTab, setSumTab] = (0, import_react.useState)("pay");
...
function MonthTable({ people, existing, onSave }) {
	...
	const [rows, setRows] = (0, import_react.useState)(() => existing.filter((a) => a.name.trim()).map((a) => ({
		name: a.name,
