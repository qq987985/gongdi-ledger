...
import { D as hashPassword, E as Button, O as lockGate, _ as pullNasLedger, a as authStatus, i as authOp, k as unlockGate, m as nasEnabled, n as Label, r as WinUpdate, t as Input, v as pushNasBackup } from "./router-D_p-605U.mjs";
import { B as require_react, z as require_jsx_runtime } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { B as PRESETS, E as nextYear, I as wageLabel, M as parseOtRule, T as monthStatus, _ as confirmRemoveYear, b as derivedYears, n as useApp, z as PERM_GROUPS } from "./router-D_p-605U2.mjs";
import { r as useCan, t as Can } from "./can-gkGWV5bu.mjs";
import { t as clearAllPhotos } from "./photos-BbG820mL.mjs";
import { n as PayTypePick, t as OtRulePick } from "./pay-fields-CwIWOzWx.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/settings-BEuqBdx4.js
...
function SettingsPage() {
	...
	const [custom, setCustom] = (0, import_react.useState)(nextYear(years));
	const [wage, setWage] = (0, import_react.useState)(200);
	const [monthWage, setMonthWage] = (0, import_react.useState)(8e3);
	const [payType, setPayType] = (0, import_react.useState)("day");
	const [rule, setRule] = (0, import_react.useState)("按小时:25");
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WinUpdate, {}),
...
function MembersCard() {
	...
	const [preset, setPreset] = (0, import_react.useState)("read");
...
function AccountsCard() {
	...
	const [users, setUsers] = (0, import_react.useState)([]);
	const [bookName, setBookName] = (0, import_react.useState)("");
	const [renaming, setRenaming] = (0, import_react.useState)("");
	const [renameTo, setRenameTo] = (0, import_react.useState)("");
	const [uName, setUName] = (0, import_react.useState)("");
	const [uUser, setUUser] = (0, import_react.useState)("");
	const [uPwd, setUPwd] = (0, import_react.useState)("");
	const [joinCur, setJoinCur] = (0, import_react.useState)(true);
	const [joinPreset, setJoinPreset] = (0, import_react.useState)("read");
	const [resets, setResets] = (0, import_react.useState)({});
	const [edits, setEdits] = (0, import_react.useState)({});
	const [oldPwd, setOldPwd] = (0, import_react.useState)("");
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						variant: "outline",
						size: "sm",
						onClick: () => setIds([.../* @__PURE__ */ new Set([...ids, ...visibleIds])]),
						children: "全选当前列表"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						type: "button",
